...
- Additionally, we also had a _Bad Touch Layered Finesse_, where by duplicating a card that would otherwise result in a one-blind-play _Bluff_, you could turn a _Bluff_ into a _Layered Finesse_.
