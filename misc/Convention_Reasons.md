...
- The Hyphen-ated group closely follows *[Good Touch Principle](https://zamiell.github.io/hanabi-conventions/docs/first_principles#4-good-touch-principle)*. A common problem with *Good Touch Principle* is when one player has two copies of the same card in their hand. Even if the card is playable right now (e.g. a red 1), cluing it would be a no-no, since it would be a *Bad Touch*.
...
- In the Hyphen-ated convention framework, we extend the *[Bluff](https://zamiell.github.io/hanabi-conventions/docs/level_8#the-bluff)* convention, allowing players to *Bluff* with [any 3 that they want](https://zamiell.github.io/hanabi-conventions/docs/level_9#the-3-bluff). Why?
...
- In the Hyphen-ated convention framework, [we discard known trash from left-to-right](https://zamiell.github.io/hanabi-conventions/docs/level_9#the-trash-order-chop-move). Why?
...
- In the Hyphen-ated convention framework, we arbitrarily decide that [*Elimination Finesses* call for the right-most card](https://zamiell.github.io/hanabi-conventions/docs/level_13#the-elimination-finesse) instead of the left-most card. Why?
