...
* In the later American release of the game, [the printed rules](https://github.com/Zamiell/hanabi-conventions/blob/master/misc/Rules.md) make it a point to explicitly mention:
