...
#### What's the reason to play 1’s in reverse order?

https://github.com/Zamiell/hanabi-conventions/blob/master/misc/Convention_Reasons.md
...
* If there is not an existing issue, then make one. (You will need to create a free GitHub account.)
...
No! There are FIVE conditions where *Tempo Clues* are allowed. If any of these five conditions are true, then you should not *Chop Move*:

https://github.com/Zamiell/hanabi-conventions/blob/master/Reference.md#the-tempo-clue-re-cluing-a-card-to-play
...
* Here, a red 1 matches a a red color clue, so it is a *Finesse*.
