...
* However, just like any other suit, *Good Touch Principle* still applies to pink cards. Players should 1) do their best to not duplicate pink cards and 2) assume by default that the remaining pink cards in their hand are "good".
