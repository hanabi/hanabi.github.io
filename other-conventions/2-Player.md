...
* If a *Save Clue* was given on the first turn of the game, then the next player is not allowed to discard. They must instead give a give a stall clue. (Otherwise, they are allowed to discard.)
