...
* From the previous section, we know that players should play all the known-playable cards in his hand first. As you would expect, this includes blind-plays from previous *Finesses*.
* For example, in a 3-player game:
