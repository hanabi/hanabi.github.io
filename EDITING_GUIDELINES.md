...
1. **Always capitalize and italicize special moves and terms:**
...
5. **Use "number X" or "color name" when describing clues:**
   - "Alice clues number 4 to Bob" (not "Alice clues 4 to Bob")
   - "Alice clues red to Bob"

## Card Notes

6. **Use compact shorthand notation for card notes in written text:**
...
7. **When multiple cards are possible, use commas with spaces:**
   - "r2, g2, b2" (not "rgb2")
   - "b2, b3" (not "b23")
   - In YAML `middleNote` fields, use the same format

8. **Special card note abbreviations:**
...
11. **Use clear, step-by-step explanations:**
...
12. **Reference other sections consistently:**
...
17. **Move/convention naming in headers:**
