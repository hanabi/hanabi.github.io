...
If you are a new player, do not bother reading this document. It is much better to simply read the [introductory document](https://github.com/Zamiell/hanabi-conventions/blob/master/README.md) and then start playing games with the group. You can use this document as a reference as you continue to naturally improve at the game.
