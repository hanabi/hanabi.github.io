...
* Players are **only allowed** to *Scream Discard* as an absolute last resort. This means *Scream Discards* are almost always performed **while the team is at 0 clues**. (More uncommonly, they can also be performed if the team is at 1 clue and one person on the team is *Locked*.)
