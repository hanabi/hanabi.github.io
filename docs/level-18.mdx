...
import TrashMovesStillWork from "./level-18/trash-moves-still-work.yml";
...
### Interaction with Trash Moves

- First, see the section on [Trash Moves](#elimination--elimination-notes).
