...
- For example, in a 3-player game:
  ...
  - Cathy hand is completely unclued and is as follows: `red 5, red 1, red 1, red 2, red 3`
  - Alice clues red to Bob, touching his red 4 on slot 4.
  ...
  - The only explanation is that Cathy has the red 5 in her hand. Thus, Cathy writes _Elimination Notes_ on her entire hand for the red 5.
  - Similarly, all players also write the _Chop Move_ and _Elimination Notes_.
...
- Sometimes, it is possible for the clue receiver to know that their card is trash even before the blind-player responds. This can happen if the blind-player has all copies of any potential non-trash cards matching the clue given.
- In this situation, however, _Elimination Notes_ are **not** to be written on the blind-player's hand, and the _Trash Bluff_ should proceed as it normally would!
- For example, in a 3-player game:
  - Yellow 1, green 1, blue 1, and purple 4 are played on the stacks.
  ...
  - Alice, wanting to _Chop Move_ Cathy's 3s and get Bob's green 2, clues red to Cathy, touching her red 4.
  - Bob knows that if he doesn't react, Cathy will assume that her card is the red 5.
  - Before reacting, however, Bob remembers that he has four 5s in his hand. If he has the red 5 in his hand, then similar to the previous example, this would be a valid _Trash Chop Move_ on Cathy.
  - Bob knows, however, that he is not supposed to assume that he has the red 5, the only non-trash red card.
  - Bob blind-plays his _Finesse Position_ card to fulfill the _Trash Bluff_, and it is a playable green 2.
  - Normally, Cathy would now know that her red card is trash because otherwise Bob would not have blind-played anything.
  - Unbeknownst to Bob, however, Cathy already knew that her red card is trash because she sees the last non-trash red card in Bob's hand.
  - Cathy discards her trash and marks all her slot 3, slot 4, and slot 5 cards as being _Chop Moved_.
- All players similarly record the _Chop Move_.
