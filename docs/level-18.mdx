...
- In this situation, the player should _Self-Chop Move_ the card. In other words, since the _Elimination Notes_ were globally known, there is no need for someone on the team to waste a clue to pervent the discard of the card.
