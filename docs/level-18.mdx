...
#### Interaction Between Elimination & Potentially Unknown Trash (Forward)
...
- For example, in a 3-player game:
  ...
  - Bob knows that from _Good Touch Principle_, the only good red card is red 5. Since Bob sees the red 5 in Cathy's hand, his red card must be trash. Thus, Alice must be intending a _Trash Chop Move_.
  - Bob discards his red card and marks his slot 4 and slot 5 cards as being _Chop Moved_.
  - Cathy is surprised to see that Bob did not misplay the red 4 as a red 5.
  - The only explanation is that Cathy has the red 5 in her hand. Since there is only one copy of a useful red card left, Cathy knows the "1 copy left" _Trash Touch Elimination_ rule applies. Subsequently, Cathy writes _Elimination Notes_ on her entire hand for the red 5.
    - Hypothetically, if there were two or more "good" red cards existing, Cathy would be expected to blind-play as a _Trash Finesse_ instead.
  - Alice and Bob also record the _Chop Move_ and _Elimination Notes_.

<TrashTouchElimination2 />

#### Interaction Between Elimination & Potentially Unknown Trash (Reverse)

- First, see [the previous section](#interaction-between-elimination--potentially-unknown-trash-forward) and the section on the _[Trash Bluff](level-14.mdx#the-trash-bluff)_
- Building on the previous example, we can also consider the case where Bob and Cathy are in the reverse order.
- Normally, when a trash card is clued to initiate a _Trash Bluff_, the player who received the clue does not know the card is trash until a _Finesse Position_ blind-play has occurred.
- However, in rare cases, it is possible for the clue receiver to know that their card is trash before the blind-play. This can only happen if the blind-player is holding all copies of non-trash cards matching the clue given.
- In this situation, _Elimination Notes_ are not written and the _Trash Bluff_ should proceed normally.
- For example, in a 3-player game:
  - Red 4, green 1, and blue 1 are played on the stacks.
  - Bob has a clued red 5 in his hand. It was clued from a _5 Save_ earlier in the game, so Bob does not know the identity of the 5.
  - Cathy hand is completely unclued and is as follows: `blue 1, blue 1, red 4, blue 3, green 3`
  - Alice clues red to Cathy, touching her red 4 on slot 3.
  - Bob knows that Alice's clue is a _Play Clue_ and that Cathy will assume that her red 4 is the red 5.
  - Bob remembers that he has an unknown 5 in his hand. If his 5 is the red 5, then Alice's clue would work as a _Trash Chop Move_ on Cathy (and would not need any blind-plays).
  - However, Bob knows that there is not global knowledge about whether he is holding a red 5. Thus, Alice must not be intending a _Trash Chop Move_ after all.
  - Thus, Bob knows that for the purposes of playing into _Trash Bluffs_, you are not supposed to assume that the unknown cards in your hand match the trash.
  - Bob blind-plays his _Finesse Position_ card to fulfill the _Trash Bluff_. It is a blue 2 and successfully plays on the stacks.
  - Normally, Cathy would now know that her red card is trash (because otherwise, Bob would not have blind-played anything). But unbeknownst to Bob, Cathy already knew that her red card was trash, because Cathy sees the red 5 in Bob's hand.
  - Cathy discards her trash and marks all her slot 4 and slot 5 cards as being _Chop Moved_.
  - Alice and Bob also record the _Chop Move_.
