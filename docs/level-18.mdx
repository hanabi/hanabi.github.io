...
- However, in rare cases, it is possible for the clue receiver to know that their card is trash before the blind-play. This can only happen if the blind-player has all copies of potential non-trash cards matching the clue given.
- In this situation, _Elimination Notes_ are not written and the _Trash Bluff_ should proceed as per normal.
- For example, in a 3-player game:
  - Yellow 1, green 1, blue 1, and purple 4 are played on the stacks.
  - Bob has four 5s in his hand, all of which are clued from a _5 Save_ earlier in the game. One of his 5s is red.
...
- Similarly, all players also record the _Chop Move_.
