...
- For example, in a 3-player game:
  - Purple 4 and all the other 1s except red 1 are played on the stacks.
...
- First, see the section on the _[Trash Bluff](level-14.mdx#the-trash-bluff)_.
...
- For example, in a 3-player game:
  - Red 4 and all the other 1s except purple 1 are played on the stacks.
