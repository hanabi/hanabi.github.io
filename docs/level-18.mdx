---
id: level-18
title: Level 18 - 5 Tech
---

import TheFivePull from "@site/image-generator/yml/level-18/the-five-pull.yml";
import TheFivePullPrompt from "@site/image-generator/yml/level-18/the-five-pull-prompt.yml";
import TheFivePullDoubleFinesse from "@site/image-generator/yml/level-18/the-five-pull-double-finesse.yml";
import TheFivePullClandestineFinesse from "@site/image-generator/yml/level-18/the-five-pull-clandestine-finesse.yml";
import TheFivePullPromise from "@site/image-generator/yml/level-18/the-five-pull-promise.yml";
import FiveNumberDischarge from "@site/image-generator/yml/level-18/five-number-discharge.yml";
import InteractionsBetween2SavesAnd5Stalls from "@site/image-generator/yml/level-18/interaction-between-2-saves-and-5-stalls.yml";
...
- First, see the section on the _[5 Stall](level-8.mdx#the-5-stall-intermediate-section)_.
...
- For level 21+ players, there are [additional rules](level-21.mdx#interaction-with-5-rank-clues) relating to _Early 5's Chop Moves_.
  <br />
...
- More examples of a _5 Number Discharge_ can be found [here](examples/5-number-discharge.mdx).
