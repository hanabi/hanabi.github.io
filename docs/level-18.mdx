...
- Sometimes, a player will have narrowed down their _Elimination Notes_ to one specific card. Thus, even though the card has no positive clues on it, they know the exact identity of the card.
- In this situation, the player should _Chop Move_ the card. In other words, since the _Elimination Notes_ were globally known, there is no need for someone on the team to waste a clue to pervent the discard of the card.
