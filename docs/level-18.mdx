...
- Sometimes, it is possible for a player later in the turn order not to know that everyone else already knows the clued card is trash.
...
- In this situation, _Elimination Notes_ are not written and the _Trash Bluff_ should proceed normally. This is because it is possible for the blind-player to actually not have the missing cards.
- For example, in a 3-player game:
  - Red 4, green 1, and blue 1 are played on the stacks.
  ...
  - Bob knows, however, that there is not global knowledge about whether he is holding a red 5. Thus, Alice must not be intending a _Trash Chop Move_ after all.
