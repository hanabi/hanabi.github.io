...
- For example, in a 3-player game:
  ...
  - However, Bob knows that for the purposes of playing into _Trash Bluffs_, you are not supposed to assume that the unknown cards in your hand match the trash. Thus, Bob blind-plays his _Finesse Position_ card to fulfill the _Trash Bluff_. It is a blue 2 and successfully plays on the stacks.
