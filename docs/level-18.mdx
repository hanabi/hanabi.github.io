...
#### Interaction Between Trash Touch Elimination & Potentially Unknown Trash (Forward)
...
- For example, in a 3-player game:
  ...
  - Alternatively, if there were two or more "good" copies of red cards existing, Cathy would be expected to blind-play as a _Trash Finesse_ instead.

<TrashTouchElimination2 />

#### Interaction Between Trash Touch Elimination & Potentially Unknown Trash (Reverse)
