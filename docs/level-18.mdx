...
- Note: A clue that touches multiple new cards is to be treated as an _Elimination Play Clue_ only if it singles out a card with an _Elimination Note_ on it for an **immediately** playable card, meaning _Elimination Play Clues_ cannot be entertained as a _Delayed Play Clue_, a _Prompt Clue_ or a _Finesse Clue_.
