...
- For example, in a 3-player game:
  - Purple 4, yellow 1, green 1, and blue 1 are played on the stacks.
  - Bob's hand is completely unclued but contains a purple 4 and a few useful 3s behind it.
  - Alice clues purple to Bob, touching his purple 4 in slot 2.
  - Bob sees that Cathy has the purple 5 in her hand. So, Alice must be intending a _Trash Chop Move_.
  - Bob discards his purple card and marks his slot 3, slot 4, and slot 5 cards as being _Chop Moved_.
  - Cathy is surprised to see that Bob did not go on to misplay his purple card as purple 5.
  - The only explanation is that Cathy actually has the missing purple card in her hand, so she writes _Elimination Notes_ on her entire hand for the purple 5.
