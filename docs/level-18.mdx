...
- For example, in a 3-player game:
  ...
  - Alice clues red to Cathy, touching her red 4.
  - Bob knows that Alice's clue is a _Play Clue_ and that Cathy will assume that her red 4 is the red 5. Thus, Alice's clue appears to be a _Trash Bluff_.
  ...
  - However, Bob knows that for the purposes of playing into _Trash Bluffs_, you are not supposed to assume that the unknown cards in your hand match the trash.
  - Thus, Bob blind-plays his _Finesse Position_ card to fulfill the _Trash Bluff_. It is a blue 2 and successfully plays on the stacks.
