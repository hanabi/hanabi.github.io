...
- In order to cover both cases, Alice _must_ take the more conservative approach and always perform a _Generation Discord_. These kinds of _Generation Discards_ are called _Cautious Generation Discards_ to differentiate them from the more ordinary kind.
