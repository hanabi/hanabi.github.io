...
- This chart shows some existing _Signal Shift_ conventions and how they relate to the three _Signals_. (If image is hard to read, click on the "moon" icon in the top-right-hand corner.)
