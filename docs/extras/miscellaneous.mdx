...
import EliminationRewrite from "./miscellaneous/elimination-rewrite.yml";
...
- However, what if they are _Prompted_ for two cards of the same multi-color suit? They should play the card with the most positive information first, even if it is not the leftmost card.
