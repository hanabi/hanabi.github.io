...
- For example, in a 3-player game:
  ...
  - Bob knows that if Alice is not making a mistake, she is communicating a _Misplay Chop Move_. Bob marks his slot 3 and slot 5 cards are being _Chop Moved_. Additionally, Bob marks his other blue card in slot 4 as being a blue 3, a blue 4, or a blue 5. Bob's chop is now his slot 2 card.
