...
import MisplayCM from '@site/static/img/examples/misplay-chop-move.svg';
import DoubleOCM from '@site/static/img/examples/double-order-chop-move.svg';
...
- First, see the section on the *[Scream Discard](../level-6.mdx#the-scream-discard-chop-move-sdcm)* and the *[Hesitation Blind-Play](../level-22.md#the-hesitation-blind-play)*.
