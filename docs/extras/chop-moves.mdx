...
import MisplayChopMove from '@site/static/img/examples/misplay-chop-move.svg';
import DoubleOrderChopMove from '@site/static/img/examples/double-order-chop-move.svg';
