...
- _Bad Chop Move ._ can be performed throughout the game. (But keep in mind that in the _End-Game_, a player might just be stalling.)
...
- In most circumstances, _Replay ._ can not be performed by re-cluing a card in Bob's hand. This is because Bob would interpret it as a _Fix Clue_, meaning that the card that Bob was about to play is actually bad and that he should discard it instead of playing it.
