...
- The *5 Color Ejection* is covered at [level 15](../level-15.mdx#the-5-color-ejection-5ce).
...
- First, see the section on the [Trash Push](../level-13.mdx#the-trash-push).
...
- More examples of a *Rank Choice Ejection* can be found [here](../examples/rank-choice-ejection.mdx).

<br />

### The Trash Ejection

- First, see the section on the *[Trash Double Ignition](../level-20.mdx#the-trash-double-ignition)*.
...
- First, see the section on the *[Replay Double Ignition](../level-20.mdx#the-replay-double-ignition)*.
...
- First, see the section on the *[Poke Double Ignition](../level-20.mdx#the-poke-double-ignition)*.
