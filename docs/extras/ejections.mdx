...
### The Bad Trash Bluff Ejection

- Since maximum level games assume that _[Trash Finesses and Trash Bluffs Are Always Unnecessary](../level-25.mdx#trash-finesses-and-trash-bluffs-are-always-unnecessary)_, it can be immediately seen as strange to give a _Trash Bluff_ that will result in a _Trash Chop Move_ of all unknown trash.
- If such a 'Bad Trash Bluff' is given, the reacting player can therefore trust that they are not being called to play slot 1, as in a normal _Trash Bluff_.
- Instead, the reacting player should _Eject_, as a special form of _Bad Chop Move Ejection_.
- This simultaneously identifies the clued card(s) as trash and communicates a _Signal Shift_ from _Save_ --> _Trash_ on the would-be-_Chop Moved_ card(s).
- For example, in a 3-player game:
  ...
  - Alice clues number 1 to Cathy, calling for a play.
  - Bob knows that regardless of his hand layout, him blind-playing from _First Finesse_ would always result in Cathy _Chop Moving_ trash (red 2).
  - Since that would be a _Bad Chop Move_, Bob knows Alice must be intending for a _Bad Trash Bluff Ejection_. Bob blind-plays his _Second Finesse Position_ card and it is a blue 1 and successfully plays.
  - Cathy knows that her clued 1 must be trash, and that the card behind it (red 2) is also now (globally known) trash.

<br />

### The Trash Bluff Push Ejection

- First, see the sections on _[Trash Push Ejection](#trash-push-ejection)_ and on _[The Bad Trash Bluff Ejection](#the-bad-trash-bluff-ejection)_.
- If a player performs a _Trash Bluff_ that touches the clued _Chop_, this will now always additionally result in a _Trash Push_ (since _[Trash Finesses and Trash Bluffs Are Always Unnecessary](../level-25.mdx#trash-finesses-and-trash-bluffs-are-always-unnecessary)_.
- So what if such a _Trash Bluff_ is given, but the responding player sees that the resulting _Pushed_ card could never be playable by the time it will blind-play? In other words, what if the card is two or more blind-plays away from playable, even when including potential intermediary teammates?
- In this situation, they intend for an _Ejection_ (instead of a normal _Trash Bluff_) on the very next player.
- This results in a _Signal Shift_ from _Play_ --> _Save_, for the _Pushed_ card.
