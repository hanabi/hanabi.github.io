...
import BadChopMove from "./ejections/bad-chop-move.yml";
...
- The _5 Number Ejection_ is covered at [level 19](../level-19.mdx#the-5-number-ejection-5ne).
...
- _Bad Chop Move Ejections_ do not always apply:
  - In general, _Chop Move_-related clues are turned off as soon as there are no cards left to _Chop Move_. Specifically, this means _one-away-from-playable_ cards that cannot be given a direct _Play Clue_ or _Save Clue_. Thus, if there are no cards left to _Chop Move_, a _Bad Chop Move Ejection_ would transform into something else, like a _Double Ignition_ of some sort.
  - Sometimes, players perform _Chop Moves_ on the other copy of currently clued cards. This can be useful for distribution purposes, so that everyone will have a card to play on the final round of the game. For this reason, a _Bad Chop Move Ejection_ can only be triggered when _Chop Moving_ cards that have been played already.
  - Remember that in the _End-Game_, a player that gives a clue that looks like a _Bad Chop Move Ejection_ might just be stalling.

### The Bad Trash Finesse Ejection / The Bad Trash Bluff Ejection

- Since we assume that [_Trash Finesses_ and _Trash Bluffs_ are always unnecessary](../level-24.mdx#trash-finesses-and-trash-bluffs-are-always-unnecessary), it would be strange if a _Trash Finesse_ resulted in a _Chop Move_ of all trash.
...
- If a player performs a _Trash Finesse_ by touching a chop card, this will always result in a _Trash Push_ (since _[Trash Finesses and Trash Bluffs are always unnecessary](../level-24.mdx#trash-finesses-and-trash-bluffs-are-always-unnecessary)_.
...
- After a _Trash Finesse Push Ejection_, the clued player should _Chop Move_ the pushed card for that. (This is similar to how [5 Number Ejection](../level-19.mdx#the-5-number-ejection-5ne) works.)
...
- First, see the section on the _[Trash Double Ignition](../level-21.mdx#the-trash-double-ignition-tdi)_.
...
- First, see the section on the _[Replay Double Ignition](../level-21.mdx#the-replay-double-ignition-rdi)_.
...
- First, see the section on the _[Poke Double Ignition](../level-21.mdx#the-poke-double-ignition-pdi)_.
