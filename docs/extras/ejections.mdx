...
- First, see the section on the _[Trash Double Ignition](../level-22.mdx#the-trash-double-ignition)_.
...
- First, see the section on the _[Replay Double Ignition](../level-22.mdx#the-replay-double-ignition)_.
...
- First, see the section on the _[Poke Double Ignition](../level-22.mdx#the-poke-double-ignition)_.
