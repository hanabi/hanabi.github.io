...
- For example, in a 4-player game:
  ...
  - Normally, _Ejection_ calls for the _Second Finesse Position_, but in this case, Cathy knows that _Stacked 5 Color Ejections_ call for the _First Finesse Position_ instead of the _Second Finesse Position_.
  - Cathy blind-plays slot 2 (instead of slot 3), and it is the green 1.
