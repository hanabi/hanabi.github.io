...
- In practice, _Trash Push Discharges_ are extremely rare, because [_Trash Double Ignition_](../level-21.mdx#the-trash-double-ignition-tdi) takes precedence. Thus, before _Discharging_, players should take extra care to ensure that there are no other more-ordinary possibilities for the clue.
