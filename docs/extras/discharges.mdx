...
- The *Unknown Trash Discharge* is introduced at [level 15](../level-15.mdx#the-unknown-trash-discharge-1-for-1-form-utd).
...
- The *5 Number Discharge* is introduced in [level 17](../level-17.mdx#5-number-discharge-5nd).
...
- First, see the section on *[Unknown Trash Discharge](../level-15.mdx#the-unknown-trash-discharge-1-for-1-form-utd)*.
