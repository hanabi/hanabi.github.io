...
- The _Priority Bluff_ is covered at [level 20](../level-20.mdx#the-priority-bluff).

### The No-Information Double Bluff

- The _No-Information Double Bluff_ is covered at [level 21](../level-21.mdx#the-no-information-double-bluff).
...
- First, see the section on the [_Hesitation Blind-Play_](../level-24.mdx#the-hesitation-blind-play).
