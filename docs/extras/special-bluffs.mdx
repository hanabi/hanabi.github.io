...
- The _3 Bluff_ is covered at [level 13](../level-13.mdx#the-3-bluff).

### The Critical Color Bluff (CCB)

- The _Critical Color Bluff_ is covered at [level 13](../level-13.mdx#the-critical-color-bluff-ccb).

### The Good Touch Bluff

- The _Good Touch Bluff_ is covered at [level 13](../level-13.mdx#the-good-touch-bluff).

### The Trash Bluff

- The _Trash Bluff_ is covered at [level 14](../level-14.mdx#the-trash-bluff).

### The Pestilent Double Bluff (PDB)

- The _Pestilent Double Bluff_ is covered at [level 15](../level-15.mdx#the-pestilent-double-bluff-pdb).

### The No-Information Double Bluff (NIDB)

- The _No-Information Double Bluff_ is covered at [level 20](../level-20.mdx#the-no-information-double-bluff-nidb).

### The Priority Bluff

- The _Priority Bluff_ is covered at [level 25](../level-25.mdx#the-priority-bluff).
...
- Expert players can use _Self Color Bluffs_ as a nice alternative to giving a 1-for-1 directly to the card on _Finesse Position_. Doing so has the advantage of "filling in" an ancillary card in the hand.
- More examples of a _Self Color Bluff_ can be found [here](../examples/self-color-bluffs.mdx).
...
- For example, in a 3-player game (similar to the previous example):
  ...
  - Bob is surprised by Cathy's blind-play and realizes that it must be related to the clue that Alice gave. If Bob had a red 4 in his hand, then Cathy would not have gone on to blind-play anything. So, Bob erases his note of "r4" and instead writes "r5", because that is the only red card that is _two-away-from-playable_, and is the only card that would make Cathy blind-play.

<SelfColorDoubleBluff />

- More examples of a _Self Color Double Bluff_ can be found [here](../examples/self-color-bluffs.mdx).
...
- First, see the section on the [_Hesitation Blind-Play_](../level-23.mdx#the-hesitation-blind-play).
...
- It is extremely dangerous for the player performing the _Pass Bluff_ to discard their chop, because everyone else on the team is expecting them to blind-play. For this reason, _Pass Bluffs_ should be performed by giving an unrelated clue or by discarding known trash.
- Importantly, it is illegal for a player to perform a _Pass Bluff_ if they could be _Bluffed_. (This is because the first _Bluff_ would not resolve immediately and would violate [_Lie Principle_](../level-11.mdx#lie-principle).)
  - Subsequently, it is also illegal for a player to pass an _Ejection_, _Discharge_, etc. to the next player.
