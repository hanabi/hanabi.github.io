...
- More examples of a *Self Color Bluff* can be found [here](../examples/self-color-bluff.mdx).
...
- More examples of a *Self Color Double Bluff* can be found [here](../examples/self-color-double-bluff.mdx).

<br />

### Stacked Bluffs (Exception)

- First, see the section explaining that [*Stacked Bluffs* are illegal](../level-10.mdx#stacked-bluffs-illegal).
...
- First, see the section on the *[Hesitation Blind-Play](../level-22.mdx#the-hesitation-blind-play)*.
...
- Examples of a *Purge Bluff* can be found [here](../examples/purge-bluff.mdx).
