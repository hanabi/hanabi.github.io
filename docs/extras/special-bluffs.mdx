...
- First, see the section explaining that [_Stacked Bluffs_ are illegal](../level-10.mdx#stacked-bluffs-illegal).
...
- First, see the section on the _[Hesitation Blind-Play](../level-23.mdx#the-hesitation-blind-play)_.
