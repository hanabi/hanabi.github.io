...
- The _Hidden Finesse_ is covered at [level 5](../level-5.mdx#the-hidden-finesse).

### The Layered Finesse

- The _Layered Finesse_ is covered at [level 5](../level-5.mdx#the-layered-finesse).

### The Clandestine Finesse

- The _Clandestine Finesse_ is covered at [level 5](../level-5.mdx#the-clandestine-finesse).

### The Queued Finesse

- The _Queued Finesse_ is covered at [level 5](../level-5.mdx#the-queued-finesse).

### The Ambiguous Finesse

- The _Ambiguous Finesse_ is covered at [level 5](../level-5.mdx#the-ambiguous-finesse).

### The Sarcastic Finesse

- The _Sarcastic Finesse_ is covered at [level 10](../level-10.mdx#the-sarcastic-finesse).

### The Certain Finesse

- The _Certain Finesse_ is covered at [level 10](../level-10.mdx#the-certain-finesse--the-certain-discard).

### The Composition Finesse

- The _Composition Finesse_ is covered at [level 10](../level-10.mdx#the-composition-finesse).

### The Selfish Finesse

- The _Selfish Finesse_ is covered at [level 12](../level-12.mdx#the-selfish-finesse-a-finesse-through-your-own-hand).

### The Trash Finesse

- The _Trash Finesse_ is covered at [level 14](../level-14.mdx#the-trash-finesse).

### The Trash Push Finesse

- The _Trash Push Finesse_ is covered at [level 14](../level-14.mdx#the-trash-push-prompt--the-trash-push-finesse).

### The Elimination Finesse

- The _Elimination Finesse_ is covered at [level 18](../level-18.mdx#the-elimination-finesse).

### The 5 Pull Finesse

- The _5 Pull Finesse_ is covered at [level 19](../level-19.mdx#the-5-pull-prompt--the-5-pull-finesse).

### The Occupied Finesse

- The _Occupied Finesse_ is covered at [level 20](../level-20.mdx#the-occupied-play-clue--the-occupied-finesse-opc).

### The Out-of-Order Finesse

- The _Out-of-Order Finesse_ is covered at [level 20](../level-20.mdx#the-out-of-order-finesse).

### The Suboptimal Finesse

- The _Suboptimal Finesse_ is covered at [level 20](../level-20.mdx#the-suboptimal-prompt--the-suboptimal-finesse--the-suboptimal-bluff).

### The No-Information Finesse

- The _No-Information Finesse_ is covered at [level 20](../level-20.mdx#the-no-information-finesse).

### The Priority Finesse

- The _Priority Finesse_ is covered at [level 25](../level-25.mdx#the-priority-prompt--the-priority-finesse).

### The Trust Finesse

- The _Trust Finesse_ is covered at [level 25](../level-25.mdx#the-trust-finesse-a-priority-finesse-from-playing-an-unknown-card).

### The Ambiguous Finesse Pass-Back (AFPB)

- First, see the section on the [_Ambiguous Finesse_](../level-5.mdx#the-ambiguous-finesse).
...
- _Certain Finesses_ **can** be performed from _Bluff Seat_ if it is strictly impossible to be a _Bluff_. In other words, this means that it is illegal for a player to perform a _Clandestine Finesse_ on the very next player that targets a potentially duplicated card if the other player can rule out the possibility of a _Bluff_.
- For example, in a 3-player game:
  ...
  - However, since Alice is in Bob's _Bluff Seat_, Bob must consider whether this could be a _Bluff_. Bob knows that since the stacks have all the 2's, anything that he blind-plays here would have to be a 3. Thus, this cannot be a _Bluff_, as a 3 would connect to 4 and look like a _Finesse_.
  - The only other possibility that Bob has to worry about is a _Clandestine Finesse_. For example, he could be blind-playing a blue 3 **and then** a red 3 after that. If he blind-discarded, the team would lose the only visible copy of the blue 3, which would be really bad.
...
- With that said, it is sometimes possible to construct **safe** lines that contain a _Lie Component_. There is usually deep levels of nuance involved in these lines, so this kind of thing is only recommended for expert players.
...
- In these situations, the player giving the clue has a completely _Free Choice_ between rank and color. We agree that by default, players should use color to save the card.
- If players instead use a rank clue to save the card, this communicates a _Rank Choice Save Finesse_.
- In the same way, it is also possible to perform a _Rank Choice Save Bluff_.
