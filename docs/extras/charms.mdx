...
- The *4 Charm* is introduced at [level 22](../level-22.mdx#the-4-charm).
...
- First, see the section on the *[Out-of-Order Finesse](../level-19.mdx#the-out-of-order-finesse)*.
...
- First, see the section on the *[Unknown Trash Discharge](../level-15.mdx#the-unknown-trash-discharge-1-for-1-form-utd)*.
