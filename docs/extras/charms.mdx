...
- The _4 Charm_ is introduced at [level 22](../level-22.mdx#the-4-charm).
...
- First, see the section on the _[Out-of-Order Finesse](../level-19.mdx#the-out-of-order-finesse)_.
...
- First, see the section on the _[Unknown Trash Discharge](../level-15.mdx#the-unknown-trash-discharge-1-for-1-form-utd)_.
