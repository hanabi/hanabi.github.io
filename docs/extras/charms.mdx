...
import FourCharmInteractionDoubleBluff from "@site/image-generator/yml/extras/charms/4-charm-interaction-double-bluff.yml";
import FourCharmInteractionHardDoubleBluff from "@site/image-generator/yml/extras/charms/4-charm-interaction-hard-double-bluff.yml";
import FourCharmInteractionOOO from "@site/image-generator/yml/extras/charms/4-charm-interaction-ooo.yml";
