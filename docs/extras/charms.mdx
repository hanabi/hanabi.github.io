...
- As stated in the [level 23](../level-23.mdx#the-4-charm) section, _Double Bluffs_ have precedence over _4 Charms_. However, there is one small exception.
...
- For example, in a 4-player game:
  ...
  - Bob blind-plays his _Fourth Finesse Position_ card. It is a green 1.
...
- Even when Cathy's card is one-away-from-playable, there are still some situations in which a _4 Charm_ is invalid, and therefore a _Double Bluff_ can still be executed. Two such situations are described below.
  ...
  - For example, in a four-player game:
    ...
    - Alice clues number 4 to Donald, focusing a green 4.
    ...
    - Cathy sees that the green 4 was more than one-away-from-playable, and hence was not a valid _Bluff_ target for a single _Bluff_. So, Cathy also blind-plays her _Finesse Position_.
...
- For example, in a 4-player game:
  - It is the first turn and nothing is played on the stacks.
  - Donald's hand is, from newest to oldest: `blue 3, red 4, red 1, blue 3`
