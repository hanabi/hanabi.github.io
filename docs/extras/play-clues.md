...
import SelfishFocusInversion from '@site/image-generator/yml/extras/selfish-focus-inversion.yml';
...
- First, see the section on the *[Selfish Clue](../level-11.md#the-selfish-clue)*.
