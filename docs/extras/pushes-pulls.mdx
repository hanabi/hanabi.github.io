...
- The _Trash Push_ is covered at [level 14](../level-14.mdx#the-trash-push).

### The 5 Pull

- The _5 Pull_ is covered at [level 19](../level-19.mdx#the-5-pull).
...
- Similarly to a _5 Pull_, if multiple cards are touched, the pulled card is next to the leftmost one of them,
