...
- _Trash Pulls_ take precedence over _Trash Double Ignition_. This means that if everyone can see that the _Trash Pull_ was necessary to "get" a blocking card, then no-one else on the team is promised to have a playable card. (This follows from _[Occam's Razor](../level-10.mdx#clue-interpretation--occams-razor)_.)
