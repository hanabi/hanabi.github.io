...
import DoubleBluffLooksLikeHalf from "./level-15/double-bluff-looks-like-half.yml";
import DoubleBluffThreeAway from "./level-15/double-bluff-three-away.yml";
import DoubleBluff from "./level-15/double-bluff.yml";
import DoubleHalfBluff from "./level-15/double-half-bluff.yml";
...
import RainbowDoubleBluff from "./level-15/rainbow-double-bluff.yml";
