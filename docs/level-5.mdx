...
- Sometimes, players who have been *Layered Finessed* cannot play their cards right away. When this happens, they will be giving clues or discarding.
- Thus, it is possible for a person in a *Layered Finesse* to accidently give a *Play Clue* to a card in someone else's hand that was already "gotten" inside of the *Layered Finesse* of their own hand.
- When this happens, it is usually obvious what is going on, and the person who is clued can safely discard the card (to prevent a bomb later on when the person who is *Layered Finessed* "unravels" the *Finesse*.
