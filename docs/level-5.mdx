...
- Thus, it is possible for a person in a *Layered Finesse* to accidently duplicate a card that was already "gotten" inside of the *Layered Finesse* in their own hand.
- When this happens, it is usually obvious, and the person who is clued can safely discard the card (to prevent a bomb when the *Layered Finesse* "unravels" the *Finesse*.
