...
- Here, Cathy is actually the one making the mistake. *Finesses* are considered to be basic moves, so the idea is that you should trust that your teammates are not making a mistake. If Bob is discarding, then it means that Cathy also has the exact same copy of the card, and Cathy should immediately blind-play.
