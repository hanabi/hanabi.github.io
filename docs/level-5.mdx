...
import PromptMultiColor from '@site/static/img/examples/prompt-multicolor.svg';
import PromptMultiColorNoNegative from '@site/static/img/examples/prompt-multicolor-no-negative.svg';
import HiddenFinesse from '@site/static/img/examples/hidden-finesse.svg';
import LayeredFinesse from '@site/static/img/examples/layered-finesse.svg';
import ClandestineFinesse from '@site/static/img/examples/clandestine-finesse.svg';
