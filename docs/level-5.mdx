...
- If a player has been _Finessed_, then their _Finesse Position_ moves right one slot, exactly like if the blind card was clued. (This is a similar concept to how if a player has been _Chop Moved_, then their chop moves left one slot.)
...
- For example, in a 5-player game:
  ...
  - After Alice's clue, Emily marked her red card as "r2 or r3 if Cathy blind-plays red 2". However, even though Cathy did not blind-play the red 2, Emily could see that Cathy was doing an important, time-sensitive action to prevent the team from losing the game. Thus, Emily knows that she needs to give Cathy another chance to blind-play the red 2. If Cathy does not blind-play the red 2 on her next turn (and nothing else special is going on), then Emily can play her own red card as the red 2.

<UrgencyPrinciple />

### Schrödinger's Cat Principle

- Oftentimes when you are given a clue, the card could be two or more things. For example:
...
If you are new to level 5, see if you can complete [these challenge questions](challenge-questions/level-5.mdx).
