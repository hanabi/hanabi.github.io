...
import UnnecessaryTrashPushIgnition from "./level-25/unnecessary-trash-push-ignition.yml";
import UnnecessaryTrashFinesseChopMove from "./level-25/unnecessary-trash-finesse-chop-move.yml";
import UnnecessaryTrashFinesseTrashPush from "./level-25/unnecessary-trash-finesse-trash-push.yml";
import UnnecessaryBadChopMoveEjection from "./level-25/unnecessary-bad-chop-move-ejection.yml";
