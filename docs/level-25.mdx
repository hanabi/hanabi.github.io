...
import UnnecessaryTrashFinesseTrashPush from "./unnecessary-trash-finesse-trash-push.yml";
import UnnecessaryBadChopMoveEjection from "./unnecessary-bad-chop-move-ejection.yml";
