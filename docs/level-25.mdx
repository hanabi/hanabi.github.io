...
- If **known trash** is used as clue target, the "extra" thing is an _Ignition_. The _Ignition_ must on be Bob, unless Alice had a very good reason not to let Bob give the clue, similar to how _Double Ignition_ works.
- If bob was the clue target the _Ignition_ must on be Bob.
