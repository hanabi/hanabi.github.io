...
- First, see the section on the *[Scream Discard](level-6.mdx#the-scream-discard-chop-move-sdcm)* and the section on *[Phantom Playable Cards](#phantom-playable-cards)*.
