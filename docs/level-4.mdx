...
- This only applies to the order that **unknown** 1's are played in. If a hand has a mixture of known and unknown 1's, only the order of the unknown 1's can signal an _Order Chop Move_. This is because, once Alice has information about some of her 1's, she might have other reasons to play particular 1's, such as trying to play cards that allow her teammates to play cards.
