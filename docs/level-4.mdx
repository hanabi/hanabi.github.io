...
- All players should mark _Chop Moved_ cards with a "cm" note. Hanab Live will then display a white border around those cards.
...
- Note that the _5's Chop Move_ is different from the _Trash Chop Move_ in that you can only _Chop Move_ **one** card with it. Thus, if you clue a 5 and it is **two** (or more) slots away from the chop, then it is a _Play Clue_ on the 5.
...
- There are some other common situations that do **not** imply an _Order Chop Move_. Use your common sense! Here is a short list:
  - The 1 that was played had a known identity.
  - The 1 that was played had a **different amount of positive clues** than the other 1's. (Different negative clues are ignored.)
