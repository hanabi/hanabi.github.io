...
- As a matter of terminology, _Chop Moves_ are not _Save Clues_ - they are a separate category.
...
- _Chop Moves_ interact with _Temop Clues_ in a potentially confusing way. _Play Clues_ to _Chop Moved_ cards are **not** considered to be _Tempo Clues_, even though _Chop Moved_ cards are imagined to have an "invisible" clue on them.

When a _Play Clue_ is given to a _Chop Moved_ card that previously had 0 positive clues on it

s should **not** be played into _Prompts_, even though they are imagined to have an "invisible" clue on them.
