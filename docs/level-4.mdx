...
import TCM1 from '@site/static/img/examples/trash-chop-move-1.svg';
import TCM2 from '@site/static/img/examples/trash-chop-move-2.svg';
import TCM3 from '@site/static/img/examples/trash-chop-move-3.svg';
import FiveCM from '@site/static/img/examples/5-chop-move.svg';
import CMNew from '@site/static/img/examples/chop-move-new.svg';
import CMNewExc from '@site/static/img/examples/chop-move-new-exc.svg';
import CMPrompt from '@site/static/img/examples/chop-move-prompt.svg';
