...
- Similar to the _Trash Chop Move_, if a _5's Chop Move_ touches **multiple** 5's, then it only _Chop Moves_ the cards to the right of the rightmost 5.
- For example, in a 3-player game:
  - All the 1's are played on the stacks.
  - Bob has a completely unclued hand.
...
- Remember that _5 Stalls_ take precedence over _5's Chop Moves_. Thus, if a number 5 clue **could** just be a _5 Stall_ (e.g. it is the _Early Game_), then it should not _Chop Move_ anything.
