...
import TrashChopMove2 from '@site/static/img/examples/trash-chop-move-2.svg';
import TrashChopMove3 from '@site/static/img/examples/trash-chop-move-3.svg';
import FivesChopMove from '@site/static/img/examples/5-chop-move.svg';
import ChopMoveNew from '@site/static/img/examples/chop-move-new.svg';
import ChopMoveNewException from '@site/static/img/examples/chop-move-new-exception.svg';
import ChopMovePrompt from '@site/static/img/examples/chop-move-prompt.svg';
