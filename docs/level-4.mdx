...
- _Chop Moves_ interact with _Tempo Clues_ in a potentially confusing way. When a _Play Clue_ is given that touches a _Chop Moved_ card for the first time, it is **not** considered to be _Tempo Clue_, even though _Chop Moved_ cards are imagined to have an "invisible" clue on them. Instead, it is categorized as a normal _Play Clue_.
