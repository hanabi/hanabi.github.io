...
- For level 17+ players, see the *[Early 5's Chop Move](level-17.mdx#the-early-5s-chop-move)*.
- For level 20+ players, there are [additional rules](level-20.mdx#interaction-with-5-rank-clues) relating to the *5's Chop Move*.
