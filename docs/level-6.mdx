...
- Sometimes, a clue might be ambiguous and interpreted as a [_Trash Chop Move_](level-4#the-trash-chop-move-tcm) at the same time.
- We agree that such _Tempo Clues_ take precedence over _Trash Chop Moves_.
