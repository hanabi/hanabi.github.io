...
import OrderChopMove from '@site/static/img/examples/order-chop-move.svg';
import TempoClueChopMovePart1 from '@site/static/img/examples/tempo-clue-chop-move-part-1.svg';
import TempoClueChopMovePart2 from '@site/static/img/examples/tempo-clue-chop-move-part-2.svg';
