...
import OCM from '@site/static/img/examples/order-chop-move.svg';
import TempoP1 from '@site/static/img/examples/tempo-clue-chop-move-p1.svg';
import TempoP2 from '@site/static/img/examples/tempo-clue-chop-move-p2.svg';
