...
- In the previous section, we showed how to use _Clarity Principle_ to decide between two lines with two identical outcomes: prefer the less complicated line.
- But _Clarity Principle_ can apply EVEN IF one line results in a better game outcome. That might seem counterintuitive, so read on!
