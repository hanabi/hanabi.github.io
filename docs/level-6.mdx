...
- As explained in the beginner's guide, we do not typically perform *Tempo Clues*, because they do not meet *[Minimum Clue Value Principle](first-principles.mdx#2-minimum-clue-value-principle)*.
...
- For level 8 players, see the *[Allowable Stall Clues](level-8.mdx#allowable-stall-clues-stall-table)* section for the specific times when *Tempo Clue Stalls* are okay to give. If you are lower than level 8, the details are not important right now.
