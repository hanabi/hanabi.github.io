---
title: Level 22 - Rare Emergency Discards
---

import CompositionDiscard from "./level-22/composition-discard.yml";
import RebelliousDiscard from "./level-22/rebellious-discard.yml";
...
- First, see the section on the _[Scream Discard](level-7.mdx#the-scream-discard-chop-move-sdcm)_ and the section on _[Phantom Playable Cards](#phantom-playable-cards)_.
...
- First, see the section on the _[Scream Discard](level-7.mdx#the-scream-discard-chop-move-sdcm)_.
...
- Similar to a normal _Scream Discard_, all of the players who are _Chop Moved_ are not allowed to discard their chop on their next turn.
...
### The Echo Shout Discard (Illegal)
...
- First, see the section on the _[Scream Discard](level-7.mdx#the-scream-discard-chop-move-sdcm)_ and the _[Generation Discard](level-7.mdx#the-generation-discard)_.
