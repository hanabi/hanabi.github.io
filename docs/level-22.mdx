...
import ChopMoveIgnitionOneCard from "./level-22/chop-move-ignition-one-card.yml";
import ChopMoveIgnitionInteraction from "./level-22/chop-move-ignition-interaction.yml";
import ChopMoveIgnitionTwoCards from "./level-22/chop-move-ignition-two-cards.yml";
