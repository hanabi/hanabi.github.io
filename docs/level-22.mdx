...
- If multiple cards are _Chop Moved_, the (possible) target of a _Chop Move Ignition_ is the leftmost, the same as the target would have been for a _Trash Pull_.
