...
- In [_Hard_ variants](#hard-variants--easy-variants), _Early Saves_ are not legal. Instead, if an _Early Save_ is given to a _Loaded_ player, then it is treated as a _Play Clue_ on that card.
