...
- Note that *Loaded Play Clues* do not ever apply to *Chop Moves*, since *Chop Moves* are referential and do not belong in the category of moves called *Save Clues*.
