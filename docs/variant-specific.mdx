...
- Note that _Loaded Play Clues_ do not ever apply to _Chop Moves_, since _Chop Moves_ are referential and do not belong in the category of moves called _Save Clues_.
