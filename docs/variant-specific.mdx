...
- In such cases, we agree that this specific type of clue, if given to a player who is [_Loaded_](#the-early-save), must always be treated as a _Play Clue_. (This includes during the _Early Game_ and in _Double Discard Situations_.)
- For example, in a 3-player game with a gray suit:
  - Gray 1 and blue 1 are played on the stacks.
  - Bob's hand is completely unclued.
  - Alice clues a gray 3 with a rank 3 clue on Cathy, who is currently _Loaded_ with a blue 2.
  ...
  - Since Bob played, Cathy marks her card as the gray 3.
...
- For example, in a 3-player game with a gray suit:
  - Gray 1 and blue 1 are played on the stacks.
  - Bob's hand is completely unclued.
  - Alice clues a critical blue 3 with a rank 3 clue on Cathy, who is currently _Loaded_ with a gray 2.
  - Normally, Bob would assume that this is an _Early Save_. But due to the _Always Loaded Principle_, this must be a _Loaded Play Clue_.
  ...
  - Since Bob played, Cathy marks her card as the blue 3.

<AlwaysLoadedGray2 />

- The only exception to ALP is for cluing number 5 in a variant with a white suit. ALP never applies to number 5 clues. (The tempo on white 5's is not as important as the confusion it would cause with normal _Save Clues_.)
