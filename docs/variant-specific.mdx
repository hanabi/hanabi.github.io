...
- _Loaded Play Clues_ **do** apply in stalling situations (e.g. 8-clue stalling situations), but only if there are other things to do that are [equal or lower precedence](level-8.mdx#allowable-stall-clues-stall-table).
