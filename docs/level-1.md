...
- If you haven't yet read the beginner's guide, **STOP NOW** and read that instead, and only come back here after you have played 5-10 games. (This page is just intended to be used as a reference.)
