...
- For expert players, we define a specific [interaction between *5's Chop Moves* / *5 Pulls* and *2 Saves*](save_clues_non_emergency_chop_moves.md#2-saves-advanced-section-interaction-with-5s-chop-moves--5-pulls).
