...
- However, in certain situations, discarding the chop card can be dangerous (or impossible), having the potential to lower the maximum score. In those situations, the only safe action to perform is to give a clue. So, in those situations, we allow players to give low-value clues that would otherwise be illegal.
