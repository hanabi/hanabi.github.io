...
- On most turns, players will not have any known-playable (or known-trash) cards. Thus, on most turns, player will either give a clue (if it is a good clue) or discard chop (the null action).
