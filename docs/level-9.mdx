...
- Extinguishing every clue **does not** include giving clues that would violate _Good Touch Principle_. (For example, if someone has two copies of a red 1 in their hand, then the standard solution is to wait until one of the copies is discarded.)
