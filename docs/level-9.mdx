...
- For level 11 players, note that _Permission to Discard_ does not apply for Bob when Alice was blind-playing a card in a situation where [_Guide Principle_](level-11.mdx#guide-principal) applies.
