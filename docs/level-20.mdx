...
import PriorityPrompt from "./level-20/priority-prompt.yml";
import PriorityFinesse from "./level-20/priority-finesse.yml";
import PriorityBluff from "./level-20/priority-bluff.yml";
import PriorityFinesseSpecial from "./level-20/priority-finesse-special.yml";
import PriorityFinesseSpecial2 from "./level-20/priority-finesse-special-2.yml";
import PriorityIntoSomeoneElsesHand from "./level-20/priority-into-someone-elses-hand.yml";
import LoadClue from "./level-20/load-clue.yml";
import TrustFinesse from "./level-20/trust-finesse.yml";
