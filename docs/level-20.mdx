...
- Usually, when this occurs, it is because a player is in a [stalling situation](level-8.mdx#allowable-stall-clues-stall-table) and cannot discard. (This is most common in [the *End-Game*](level-7.mdx#burning-end-game-stalling).)
