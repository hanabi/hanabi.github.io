...
| -------- | ------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- |
| \*       | Unknown card                                            | Apply the table to each possible identity for the unknown card, see [here](#priority-with-both-known-and-unknown-cards). (**Reminder**: playing an unknown card [almost never](#the-trust-finesse-a-situational-priority-finesse) triggers _Priority_.) |                       |
