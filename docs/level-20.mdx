...
- For example, in a 3-player game, this would be an _Out-of-Order Finesse_:
  ...
  - Bob knows that this could be an _Out-of-Order Finesse_. Specifically, if Bob gives a follow-up number 5 _Fix Clue_ to Cathy, then Cathy would play the red 1 and the red 2, Bob would blind-play the red 3, and finally Cathy would play the red 4 and the red 5.
