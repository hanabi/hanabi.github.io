...
import PriorityFinesseSpecial2 from "@site/image-generator/yml/level-20/priority-finesse-special-2.yml";
...
| -------- | ------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- |
| \*       | Unknown card                                            | Apply the table to each possible identity for the unknown card, see [here](#priority-with-both-known-and-unknown-cards).<br/>(**Reminder**: playing an unknown card [generally](#the-trust-finesse-a-situational-priority-finesse) never triggers _Priority_.) |                       |
...
| 6        | The left-most card                                      | The left-most card is more likely to be good.                                                                                                                                                                                                                  | ✔️                    |
...
- For example, in a 3-player game:
  ...
  - Alice has a 2 of unknown color. It could be either blue 2, green 2, yellow 2, or purple 2.
  - (The rest of the team does not have any clued cards in their hands.)
  - Alice knows that red 3 has lower _Priority_ than **all** possibilities for the 2 (all possibilities for the 2 are lower rank).
...
- For example, in a 3-player rainbow game:
  ...
  - (The rest of the team does not have any clued cards in their hands.)
  - Alice plays the red 3.
  - No _Priority_ is triggered. Even though red 3 has lower _Priority_ than blue 2, red 3 does **not** have lower _Priority_ than rainbow 3 (red 3 is leftmost). Red 3 must have strictly lower _Priority_ than the unknown card to trigger _Priority_.
