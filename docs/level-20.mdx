...
- Since _No-Information_ clues are not very valuable, we agree that a _No-Information_ clue can never be a _Bluff_ that gets a single card. Instead, it must get two cards.
- For example, in a 3-player game:
