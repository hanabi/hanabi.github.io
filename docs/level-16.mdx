...
- However, there are still plenty of situations where players will intentionally duplicate a card:
  ...
  1. When a _[Phantom Playable Card](level-23.mdx#phantom-playable-cards)_ is at risk of being discarded and the preceding cards must be clued as soon as possible.
...
- At level 18, once they discard it, they should write _Elimination Notes_ on the matching cards in their hand.
- For example, in a 3-player game:
