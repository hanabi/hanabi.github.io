...
- However, there are still plenty of situations where players will intentionally duplicate a card:
  ...
  1. When a _[Phantom Playable Card](level-9.mdx#phantom-playable-cards)_ is at risk of being discarded and the preceding cards must be clued as soon as possible.
