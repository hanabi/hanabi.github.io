...
- In the previous example, a _5 Color Ejection_ was performed with the 5 being the only new card introduced with the color clue. However, it is also possible to perform a _5 Color Ejection_ with more than one card introduced.
  - For players playing at level 20, this kind of thing would normally signal an _[Out-of-Order Finesse](level-20.mdx#the-out-of-order-finesse)_, but the _5 Color Ejection_ interpretation takes precedence as long as the next player would have to blind-play two or more cards.

### The Unknown Trash Discharge (1-for-1 Form) (UTD)

- In general, _Bluffs_ work because the blind-play tells the person who was clued that they have a _one-away-from-playable_ card.
...
- For example, in a 3-player game:
  ...
  - Alice clues number 1 to Cathy, touching a green 1 on slot 1 and a red 1 on slot 2. In this example, the green 1 is "fresh", meaning the focus is on the green 1 as a _Play Clue_.
...
- For example, in a 3-player game:
  ...
  - Cathy's hand is, from newest to oldest: `red 2, red 2, red 4, blue 4, green 1`
  - Alice clues red to Cathy as a _Play Clue_, touching the red 2 on slot 1, the red 2 on slot 2, and the red 4 on slot 3.
  - Bob knows that Alice is violating _Good Touch Principle_ and duplicating the red 2. There doesn't seem to be a very good reason for this, so this must be an _Unknown Dupe Discharge_.
  - Bob blind-plays his _Third Finesse Position_. It is a blue 1 and it successfully plays on the stacks.
  - Normally, Cathy would think that this was an _Unknown Trash Discharge_. However, no red trash cards exist. Thus, this must have been an _Unknown Dupe Discharge_.
  - Cathy discards her slot 1 card (the focus of the clue). It is revealed to be a red 2. Now, Cathy knows that she has the other copy of the red 2 in either her slot 2 and her slot 3.
