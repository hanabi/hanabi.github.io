...
import KnownTrashDischarge from "@site/image-generator/yml/level-16/known-trash-discharge.yml";
...
### The Known Trash Discharge (KTD)

- First, see the section on \_[The Unknown Trash Discharge (2-for-1 Form)](#the-unknown-trash-discharge-2-for-1-form-utd)\_\_
- Sometimes, it is possible to perform a _Discharge_ using a clue that would normally look like a _Trash Bluff_, by cluing other non-trash cards.
- For example, un a 3-player game:
  - All the 1's are played on the stacks, except the red 1.
  - Alice clues 1 to Cathy, touching a green 1 on slot 1 and a red 1 on slot 2. The focus is on the green 1.
  - Bob knows that in this situation, blind-playing his slot 1 would be sufficient for Cathy to know that her green 1 is trash, so this is not an _Unknown Trash Discharge_.
  - However, by doing this, Bob would indicate to Cathy that her red 1 is also a trash since Cathy would interpret Alice's clue as a _Trash Bluff_.
  - Therefore, Bob interprets Alice's clue as a _Known Trash Discharge_ and he blind-plays his slot 3. It is a blue 2 and successfully plays.
  - Cathy sees this blind-play and knows that if her 1's were both trashes, Bob would have blind-played his slot 1.
  - Thus she marks her slot 1 as a trash and her slot 2 as red 1.

<KnownTrashDischarge />

- This is called an _Known Trash Discharge_ in order to differentiate if from a classical _Unknown Trash Discharge_ where a _Trash-Bluff_ is not sufficient for Bob to indicate Cathy that the focus of the clue is a trash.
  - For players playing with advanced terminology, this is a _[Signal Shift](extras/signal-shifting.mdx)_ from _Trash_ to _Play_, whereas a classical _Unknown Trash Discharge_ _Signal Shifts_ from _Play_ to _Trash_.
