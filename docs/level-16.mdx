...
- Note that players should not always make _Elimination Notes_ when they discard a playable card. In some cases, games can be extremely busy, leaving no reasonable way to get the playable card. Players must just use their best judgment and account for this.
