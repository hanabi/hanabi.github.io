...
- Oftentimes, cards are _Chop Moved_ towards the beginning of the game. Later on, thoe _Chop Moved_ cards will be directly clued in order to get them to play.
