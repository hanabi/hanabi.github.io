...
Here is a flowchart for determining whether something is a _Scream Discard Chop Move_ or a _Generation Discard_. (Ignore the _Echo Scream Discard Chop Move_ for now, since that move is only introduced later on.)
...
D2Y([Yes])
D2N([No])
D3[/Does Cathy have a unique playable or a critical or a unique 2 on chop?\]
D3Y([Yes])
D3N([No])
...
D5[/Does Cathy have a unique playable or a critical or a unique 2 on chop?\]
D5Y([Yes])
D5N([No])
