...
- Players are **only allowed** to _Scream Discard_ as a last resort. This means _Scream Discards_ are almost always performed **while the team is at 0 clues**. (Less commonly, they can also be performed if the team is at 1 clue and the next person happens to be _Locked_.)
