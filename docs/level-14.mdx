...
- _Reverse Trash Finesses_ **must** contain a "potential _Gentleman's Discard_". In other words, it is not possible to perform a _Reverse Trash Finesse_ that causes the matching critical card to blindplay.
- For example, in 3-player game:
