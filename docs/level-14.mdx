...
- _Double Bluffs_ are valid even if the card which Bob blind-plays connects to the card which is clued by Alice.
  ...
  - This used to be called a _Double Half Bluff_, but this term was phased out because the distinction is not really relevant: Cathy doesn't care which situation she is in, she is required to blind-play immediately either way.
