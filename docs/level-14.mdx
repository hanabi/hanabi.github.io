...
- Just like a _Trash Finesse_, a _Trash Bluff_ will also _Chop Move_ all of the cards to the right of the focused card (similar to how a _Trash Chop Move_ works).
- The focus of a trash bluff is the leftmost freshly touched card.
