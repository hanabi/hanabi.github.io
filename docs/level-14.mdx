...
- More examples of a *Pestilent Double Bluff* can be found [here](examples/pestilent-double-bluff.mdx).
...
- First, see the sections on *[Bob's Truth Principle](level-10.mdx#bobs-truth-principle-part-1)* and *[Occam's Razor](level-10.mdx#clue-interpretation--occams-razor)*.
