...
- In the case where multiple cards are clued as part of a _Trash Finesse_, **all** of the touched cards are considered to be trash, and the cards to the right of the rightmost trash card are _Chop Moved_ (similar to how a _Trash Chop Move_ works).
