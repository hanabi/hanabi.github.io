...
- In rare cases, when a _Trash Push_ happens, the card next to the clued trash card is already clued. In this situation, the closest unclued card is the one that should blind-play.
