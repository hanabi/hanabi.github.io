...
- After a _Trash Finesse_, the player who was clued should _Chop Move_ all of the cards to the right of the trash card. (In other words, you can think of a _Trash Finesse_ as both a _Finesse_ and a _Trash Chop Move_ at the same time.)
  - If the clued card in a _Trash Finesse_ was already on chop, then nothing extra happens.
    - For level 24 players, an [extra thing happens](level-24.mdx#unnecessary-moves-with-unknown-trash-on-chop----trash-push).
...
- _Double Trash Finesses_ are explicitly disallowed. Thus, it is possible to perform a _Trash Finesse_ in a situation like this:
  ...
  - Furthermore, Donald knows that his slot 2 card is also trash, because all newly touched cards in a _Trash Finesse_ are guaranteed to be trash.
...
- Similarly, in a _Trash Bluff_, Alice clues a trash card, forcing Bob to blind-play his _Finesse Position_. Bob will assume it's the originally-promised card and only knows it's a fib after he blind-plays.
