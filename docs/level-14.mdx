...
- Additionally, after a _Trash Bluff_, the player is clued should _Chop Move_ all of the cards to the right of the trash card (similar to how a _Trash Chop Move_ works).
