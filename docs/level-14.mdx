...
- For example, in a 3-player game:
  ...
  - Additionally, Cathy knows that her slot 3, slot 4, and slot 5 cards are also permanently _Chop Moved_.
...
- Just like _Trash Chop Move_ the player clued trash will cm all cards to the right of the trash card.
