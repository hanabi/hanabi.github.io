...
- First, see the section on [Playing Multiple 1's - Play Order Inversion in the Starting Hand (Part 1)](level2.md#playing-multiple-1s---play-order-inversion-in-the-starting-hand-part-1).
...
- Continuing on from the example in [Playing Multiple 1's - Part 1](level2.md#playing-multiple-1s---play-order-inversion-in-the-starting-hand-part-1), imagine that:
