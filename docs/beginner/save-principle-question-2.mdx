...
import SavePrincipleAnswer2 from "./save-principle-question-2/save-principle-answer-2.yml";
...
- Bob will also write a _card note_ of "y2, g2, b2, p2" on his slot 4.
- Therefore the other players should write a "fix" note on this card.
