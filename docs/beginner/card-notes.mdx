...
- For example, in a 3-player game:
  ...
  - Colors in card notes are shortened to the first letter. (Certain variants have exceptions. You can hover over each stack in-game for more information.)
...
- In the previous example, Bob should right-click on his red card and write "red 1" (or "r1"), so that he doesn't forget for later.
