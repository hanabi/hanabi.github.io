...
- When _Good Touch Principle_ is violated, the other players should write a "Fix" note on the duplicated cards, so that a wrench icon appears and they remember to clear up this misunderstanding later.
