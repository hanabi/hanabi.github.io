...
import SavePrincipleAnswer1 from "./save-principle-question-1/save-principle-answer-1.yml";
...
- Bob can either clue green or 4 to save the green 4. But 4 would touch another useful card, and is usually the better clue.
