...
import FinesseAnswer1 from "./finesse-question-1/finesse-answer-1.yml";
...
1. Alice can clue color green to Cathy, touching the green 4 as a _Bluff_ on the blue 1.
