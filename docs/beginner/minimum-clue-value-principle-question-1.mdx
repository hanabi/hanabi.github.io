...
import MinimumClueValuePrincipleAnswer1 from "./minimum-clue-value-principle-question-1/minimum-clue-value-principle-answer-1.yml";
...
- Bob's blue 4 has been previously touched with a blue clue.
