...
- Alice is not allowed to perfrom a _5_Stall_ on Cathy's yellow 5 because it is not the _Early Game_ or some other situation in which giving a _5_Stall_ would be legal.
