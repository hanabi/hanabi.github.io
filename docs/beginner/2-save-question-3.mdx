...
- Alice is not allowed to perform a _5 Stall_ on Cathy's yellow 5 because it is not the _Early Game_ or some other situation in which giving a _5 Stall_ would be legal.
