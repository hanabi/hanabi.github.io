...
import GoodTouchPrinciple1Illegal from "./good-touch-principle/good-touch-principle-1-illegal.yml";
import GoodTouchPrinciple1Correct from "./good-touch-principle/good-touch-principle-1-correct.yml";
...
- In the example below:
  ...
  - The focus of the clue is on slot 2. This must be a _Play Clue_, so Bob marks his slot 2 card as a yellow 3.
  ...
  - Therefore, Bob marks his slot 3 card as either yellow 4, or yellow 5.
