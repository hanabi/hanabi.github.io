...
- For example, in a 3-player game:
  ...
  - Bob knows that Alice's clue could be a direct _Play Clue_ on a yellow, green, blue, or purple 3. However, it could also be red if Alice intends a _Reverse Finesse_ through Cathy's red 2, so Bob must allow Cathy a chance to prove whether that is the case.
