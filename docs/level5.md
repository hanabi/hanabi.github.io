...
- First, see the sections on:
  - [Playing Multiple 1's - Play Order Inversion in the Starting Hand (Part 1)](level2.md#playing-multiple-1s---play-order-inversion-in-the-starting-hand-part-1)
  - [Playing Multiple 1's - The Fresh 1's Rule (Part 2)](level3.md#playing-multiple-1s---the-fresh-1s-rule-part-2)
  - [Playing Multiple 1's - The Chop Focus Exception (Part 3)](level3.md#playing-multiple-1s---the-chop-focus-exception-part-3)
