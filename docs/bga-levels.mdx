...
While levels are not the focus of playing and learning this game, playing at an appropriate level is good etiquette and helps people learn more efficiently. As a BGA player it may be difficult to assess your H-Group level, especially if you have a year or more of prior experience. This is because you will likely know some of the higher conventions (like _Bluffs_, which is a level 10 convention) while not completely knowing all of the lower level conventions (like _Chop Focus_, which is a level 1 convention, or _Double Discard Avoidance_, which is a level 8 convention).
