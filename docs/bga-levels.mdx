...
While levels are not the focus of playing and learning this game, playing at an appropriate level is good etiquette and helps people learn more efficiently. With that said, as a former BGA player, it may be difficult to assess your level, especially if you have a year or more of prior experience. This is because you will likely know some of the higher conventions (like *Bluffs*, which is a level 10 convention) while not completely knowing all of the lower level conventions (like *Chop Focus*, which is a level 1 convention, or *Double Discard Avoidance*, which is a level 8 convention).
