---
id: level-17
title: Level 17 - Elimination
---

import EliminationNotes from "@site/image-generator/yml/level-17/elimination-notes.yml";
import EliminationBlindPlay from "@site/image-generator/yml/level-17/elimination-blind-play.yml";
import EliminationPlayClue from "@site/image-generator/yml/level-17/elimination-play-clue.yml";
import EliminationSingleOutNegative from "@site/image-generator/yml/level-17/elimination-single-out-negative.yml";
import EliminationRidingDeduction from "@site/image-generator/yml/level-17/elimination-riding-deduction.yml";
import EliminationFinesse from "@site/image-generator/yml/level-17/elimination-finesse.yml";
import EliminationFinesse2 from "@site/image-generator/yml/level-17/elimination-finesse-2.yml";
import TrashTouchElimination from "@site/image-generator/yml/level-17/trash-touch-elimination.yml";
...
- For example, in a 3-player game:
  ...
  - Bob plays the red 4.
  - Now, Cathy has to interpret what happened. Normally, Alice duplicating the blue 4 would mean that she is making making a mistake or something else special is going on. However, in this situation, Cathy knows that Alice had to choose between two evils, so the number 4 clue is considered to be ordinary.
