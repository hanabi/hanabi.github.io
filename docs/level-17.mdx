...
- First, see the section on the *[5 Stall](level-8.mdx#the-5-stall-intermediate-section)*.
...
- For level 20+ players, there are [additional rules](level-20.mdx#interaction-with-5-rank-clues) relating to *Early 5's Chop Moves*.
<br />
...
- More examples of a *5 Pull Double Finesse* can be found [here](examples/5-pull-double-finesse.mdx).
...
- More examples of a *5 Number Discharge* can be found [here](examples/5-number-discharge.mdx).
...
- In this situation, players should assume the least complicated thing: a *5 Stall*. Because of the *[Visible Rule](level-1.mdx#the-visible-rule)*, the player who gave the *5 Stall* clue was not allowed to perform the *2 Save* because the other copy was visible.
