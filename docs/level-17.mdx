...
- For example, in a 3-player game:
  ...
  - Since Alice was not in a valid stalling situation and getting tempo on Bob's green 2 was not _Valuable_, Bob treats this as a _Tempo Clue Chop Move_. (Tempo on the green 2 was not _Valuable_ because the green 2 was _Promptable_ **and** because everyone knew that Alice's clue got fewer than two already-clued cards to play across all hands.)
