...
import QuestionPart1 from "./level-4-question-2/question-part-1.yml";
import QuestionPart2 from "./level-4-question-2/question-part-2.yml";
import QuestionPart3 from "./level-4-question-2/question-part-3.yml";
import Answer from "./level-4-question-2/answer.yml";

<ChallengeQuestionProgress level={4} id="level-4-question-2" />
