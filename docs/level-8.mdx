...
| Precedence | Type of Clue                                                                                             | Normal Situation (Severity 0) | Early Game (Severity 1) | Double Discard / Scream Discard (Severity 2) | Locked Hand (Severity 3) | 8 Clues (Severity 4) | Pace 0 (Severity 5) |
| ---------- | -------------------------------------------------------------------------------------------------------- | ----------------------------- | ----------------------- | -------------------------------------------- | ------------------------ | -------------------- | ------------------- |
| 1          | Normal _Play Clues_ or normal _Save Clues_                                                               | ✅                            | ✅                      | ✅                                           | ✅                       | ✅                   | ✅                  |
| 2          | _5 Stall_<br />(cluing off chop 5's)                                                                     | ❌                            | ✅                      | ✅                                           | ✅                       | ✅                   | n/a (nonsense)      |
| 3          | _Tempo Clue Stall_<br />(re-cluing a card to make it play)                                               | ❌                            | ❌                      | ✅                                           | ✅                       | ✅                   | ✅                  |
| 4 (tied)   | _Locked Hand Save_<br />(saving any card on chop, as long as doing so would not _Lock_ the other player) | ❌                            | ❌                      | ❌                                           | ✅                       | ✅                   | n/a (nonsense)      |
| 4 (tied)   | _8 Clue Save_<br />(saving any card not on slot 1)                                                       | ❌                            | ❌                      | ❌                                           | ❌                       | ✅                   | n/a (nonsense)      |
