...
- The *Early Game* is introduced in the [beginner's guide](beginner/early-game.mdx). In short:
...
- As mentioned in the [level 2](level-2.mdx#the-5-stall-cluing-off-chop-5s), *5 Stalls* are when a player clues an off chop 5 purely because they want (or need) to give a stall clue.
