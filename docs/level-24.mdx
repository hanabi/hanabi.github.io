...
import FourCharm from "./level-24/4-charm.yml";
import BlazeDiscard from "./level-24/blaze-discard.yml";
import BlazeDiscard2 from "./level-24/blaze-discard-2.yml";
import HesitationBlindPlay from "./level-24/hesitation-blind-play.yml";
