...
- This convention only applies in the _Low Score Phase_.
- When a _5 Pull_ is given, depending on the playability of the _pulled_ card, it would trigger a normal _5 Pull_, a _5 Pull Finesse_, or a _5 Pull Discharge_.
