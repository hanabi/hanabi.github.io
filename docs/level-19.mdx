...
classDef Ac fill:#61DAFB
D1[/Was the righ-most 5 on chop?\]
D1Y(Yes)
D1N(No)
...
D2Y(Yes)
D2N(No)
D3[/Were there any other _Play Clue_ or _Save Clue_ that the cluer could have given instead?\]
D3Y(Yes)
D3N(No)
D4[/Was the only thing left to do was to give a _Play Clue_ to a card on Finesse Position\]
D4Y(Yes)
D4N(No)
