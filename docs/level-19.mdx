...
- After a _5 Number Ejection_, the card next to the 5 should be globally marked as _Chop Moved_, and marked accordingly as _two-or-more-away-from-playable_. For example, in a No Variant game such a card is always a 3 or 4.
...
- This convention only applies in the _Low Score Phase_.
- First, see the section on the _[5 Number Ejection](#5-number-ejection-5ne)_.
- What if a rank 5 clue is given that should trigger a _5 Pull_ response, except the card being "pulled" is actually trash? This would be quite strange.
- We agree that this signals a _Discharge_ and that the next player should play their _Third Finesse Position_.
- For example, in a 3-player game:

  - All the 1's are played on the stack.
  - Alice clues number 5 to Cathy, touching a 5 on slot 1.
  ...
  - Since Bob knows he's expected to react in a way that will resynchronize the team, he knows that he should instead treat this as a _5 Number Discharge_. Bob blind-plays his slot 3 card and it successfully plays as the blue 2.

- After a _5 Number Discharge_, the card next to the 5 should be marked as globally known-trash.
- Furthermore, the team should be sure to mark it as a **clued** known-trash card. For example, it usually will be the next expected discard from that player for potential purposes such as _Shout Discards_ or _Trash Order Chop Moves_.

<TheFiveNumberDischarge />

### 5 Number Ejection & Discharge Finesse Position Skips

- First, see the section on the _[5 Number Ejection](#5-number-ejection-5ne)_ and _[5 Number Discharge](#5-number-discharge-5nd)_.
- After a _5 Number Ejection_ or _5 Number Discharge_ occurs, the card next to the 5 will either be marked as either a _Chop Moved_ _two-or-more-away-from-playable_ card, or known-trash.
- In the case of a _5 Number Ejection_, the _Chop Moved_ card retains its natural _Finesse Position_ order.
  - For example, if the clued 5 was on slot 1, the "marking" **does not** change the player's _Finesse Position_ - their _Finesse Position_ is still the card marked as a 3 or a 4.
...
- In the case of a _5 Number Discharge_, however, the known-trash card no longer occupies a _Finesse Position_. Instead, the team should simply treat it as a "clued", known-trash card.
  - For example, if the clued 5 was on slot 1, the player's _Finesse Position_ is now slot 3, since the known-trash card on slot 2 is globally known.
