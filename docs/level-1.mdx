...
- By definition, you can only perform a _2 Save_ with a number clue.
  - If the other copy of the 2 is in the discard pile, then you can save it with color. But that would not be a _2 Save_, that would just be a _Save Clue_ on a critical card.
...
- For level 5 players, see the [level-5.mdx#the-queued-finesse](_Queued Finesse_) section.
...
- The website has an [extensive documentation](https://github.com/Hanabi-Live/hanabi-live/blob/master/docs/features.md#notes). You can get to that page by pressing the "Help" icon in the upper-right part of the website lobby.
