...
- For level 9+ players, there are [some additional rules](level-9.md#the-early-game-severity-1-stalling) about the Early Game. (Don't worry about them for now if you are only level 1.)
