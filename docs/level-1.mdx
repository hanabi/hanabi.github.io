...
- First, see the section on *[Delayed Play Clues](beginner/delayed-play-clues.mdx)* from the beginner's guide.
...
- Players **must** "extinguish" all of the available *Play Clues* and *Save Clues* on the board before ending the *Early Game*.
  - As outlined in the [beginner's guide](beginner/minimum-clue-value-principle.mdx), "extinguishing" all the *Play Clues* does **not** include giving *Tempo Clues*. *Tempo Clues* do not meet *Minimum Clue Value Principle*, so in general, they should almost never be given.
...
- An example of a *Prompt* can be found in the [beginner's guide](beginner/prompt.mdx).
...
- *Finesses* are covered in detail in the [beginner's guide](beginner/finesse.mdx).
