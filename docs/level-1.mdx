...
- Since we play with _Good Touch Principal_, we intentionally avoid touching trash cards. However, at later levels, it can be sometimes advantageous to touch trash cards in specific situations.
