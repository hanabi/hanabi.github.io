...
- For level 2 players, there are [some additional rules about the _Early Game_](level-2.mdx#the-5-stall-cluing-off-chop-5s).
- For level 9 players, there are [even more rules about the _Early Game_](level-9.mdx#the-early-game-severity-1-stalling).
