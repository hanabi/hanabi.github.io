...
- A _5 Save_ is when someone uses a number 5 clue to clue a previously-unclued 5 on someone's chop. (Everyone agrees that this is just a _Save Clue_ instead of a _Play Clue_.)
