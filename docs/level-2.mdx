...
- For level 8 players, there are [additional rules](level-8.mdx#the-5-stall-intermediate-section) relating to the _5 Stall_.
- For level 17 players, there is a [special interaction between _2 Saves_ and _5 Stalls_](level-17.mdx#interaction-between-2-saves--5-stalls).
...
- For example, in a 3-player game:
  ...
  - On his next turn, Bob blind-plays slot 2 as red 3. (His _Finesse Position_ at the time of the clue was slot 1, but he drew a card, and now it slid down to slot 2.) and Cathy now knows she has the connecting red 4.
...
If you are new to level 2, see if you can complete [these challenge questions](/docs/challenge-questions/level-2).
