...
- However, you are **only** allowed to do this if there is nothing else to do, meaning that you do not have any immediately playable cards and that all of the "normal" _Play Clues_ and _Save Clues_ have been extinguished.
