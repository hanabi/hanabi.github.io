...
import DoubleFinesse1 from '@site/static/img/examples/double-finesse-1.svg';
import DoubleFinesse2 from '@site/static/img/examples/double-finesse-2.svg';
import PromptFinesse from '@site/static/img/examples/prompt-finesse.svg';
import ReverseFinesse from '@site/static/img/examples/reverse-finesse.svg';
import SelfFinesse from '@site/static/img/examples/self-finesse.svg';
