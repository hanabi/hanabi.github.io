...
- Have you played a bunch of games at level 1 already? If not, then **stop reading immediately**, as reading further will actually make you a worse player unless you get some practice with the fundamentals first. (Knowing "extra moves" often makes newer players do complicated things for no reason that make them a huge chore to play with.)
