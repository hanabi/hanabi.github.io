...
- (The logic behind this convention is explained [in the convention reasons document](https://github.com/hanabi/hanabi.github.io/blob/main/misc/convention-reasons.mdx#play-order-of-multiple-1s).)
