...
- At higher levels, there are situations where it matters. We agree that such clues are focused on the 1 that would play first (according to the rules above).
