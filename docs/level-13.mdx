...
- Building on the _3 Bluffs_ convention, we also agree that it is possible for a card that initiates a _Bluff_ to be any critical card, but only if **a color clue** is used, and only if **it is not a 5**.
  - Note that this includes the black 4 or any "dark" 4.
- Unlike the [_3 Bluff_](#the-3-bluff), you can only initiate a _Critical Color Bluff_ with a completely-unclued critical card.
- For example, in a 3-player game:
  - Red 1 is played on the stacks. Red 4 is currently in the discard pile.
  - Alice clues Cathy red, touching a red 4 as a _Play Clue_.
  - Bob blind-plays a blue 1.
  - Cathy marks her red card as the _one-away-from-playable_ red card, the red 3.
  - However, Cathy also knows that _Critical Color Bluffs_ are a thing, so she _also_ marks her red card as possibly a red 4.

<CriticalColorBluff />

- If the red 1 hasn't been played yet, this would also be a valid clue, and Cathy would additionally mark her red card as possibly the red 2.
