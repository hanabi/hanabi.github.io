...
- Unlike the [_3 Bluff_](#the-3-bluff), you can only initiate a _Critical Color Bluff_ with a completely-unclued critical card. (The reason is because once the card is clued, it is no longer considered to be critical.)
