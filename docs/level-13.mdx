...
import GoodTouchBluff from "@site/image-generator/yml/level-13/good-touch-bluff.yml";
import GoodTouchBluff2 from "@site/image-generator/yml/level-13/good-touch-bluff-2.yml";
...
- Our group plays with an artificial _3 Bluffs_ convention. This means that in addition to being _one-away-from-playable_, we agree that a _Bluff_ can _also_ be any 3 that will be useful in the future. (If you are curious, the history of this move is on a [separate page](https://github.com/hanabi/hanabi.github.io/blob/main/misc/3-bluffs.md).)
