...
- You can initiate a _3 Bluff_ with either a completely-unclued 3 or an already-clued 3; the connect/disconnect rules apply in both cases.
...
- You can initiate a _Critical Color Bluff_ with either a completely-unclued crticial card or an already-clued critical card; the connect/disconnect rules apply in both cases.
