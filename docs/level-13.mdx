...
- You can initiate a _Critical Color Bluff_ with either a completely-unclued crticial card or an already-clued critical card; the same connect/disconnect rules apply in both cases.
