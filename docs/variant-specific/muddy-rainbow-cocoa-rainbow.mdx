...
- In variants with a pink suit, the *[Pink Choice Tempo Clue](pink.mdx#the-pink-choice-tempo-clue)* convention is "turned on", since players often have a *Free Choice* with how they can clue pink cards. Muddy rainbow has a similar convention.
