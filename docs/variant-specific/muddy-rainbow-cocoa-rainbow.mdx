...
- Similar to brown cards, if a player gives a _Tempo Clue_ to a single muddy or cocoa rainbow card, it is never a _Tempo Clue Chop Move_.
...
- The position of the muddy rainbow card, counted **from oldest to newest** (right to left), corresponds to the ordering of the colors **from right to left**. But skip the cards that are not touched by the color clue (and the known unplayable cards). Furthermore, colors always "wrap around" to the oldest card.
