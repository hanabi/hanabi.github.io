...
- By default, muddy rainbow cards inherit all of the [rainbow conventions](rainbow.mdx) and all of the [brown conventions](brown.mdx).
...
- Similarly, by default, cocoa rainbow cards inherit all of the [rainbow conventions](rainbow.mdx), all of the [brown conventions](brown.mdx), and all of the [black conventions](black.mdx).
...
- Any red color clue (the leftmost color) to a chop card is treated as a potential _Muddy Rainbow Save_ on a muddy rainbow 2 or a muddy rainbow 5.
