...
- This exception does not apply to cards known to be not 5. This usually happens in result of bluffs given with an odd clue.
...
- An odd _Play Clue_ to a 5 signals an _Ejection_ on the next player if they have to **blind-play two or more cards** to fulfill the finesse similarly to the _5 Color Ejection_.
- The _Odd Prompt Rank Exception_ applies when counting blind-plays.
...
- For example, in a 3-player game:
  - Only Red 4 has been played and Cathy has a red card clued.
  - The only yellow card that both Alice and Bob see is Cathy's yellow 5 and Bob does not have any cards clued. 
  - Alice gives an odd clue to Cathy, touching a yellow 5 on chop.
  - Since Cathy is loaded with her playable red card the _Always Loaded Principle_ applies. Therefore, the odd clue is a _Play Clue_ on the yellow 5.
  - Since Bob has to blind-play two or more cards to fulfill the finesse he knows this is a _5 Odd Ejection_ and blind-plays his _Second Finesse Position_.
  - Cathy knows an ejection happened. The only ejection that matches this sequence is a _5 Odd Ejection_, so she marks her odd card as any non-red 5.
