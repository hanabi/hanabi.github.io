...
- Similar to the *[Ambiguous Prism Tempo Clue](prism.mdx#the-ambiguous-prism-tempo-clue)*, we agree that certain kinds of *Tempo Clues* promise that different kinds of cards are focused:
