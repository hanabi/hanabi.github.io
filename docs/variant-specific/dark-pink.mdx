...
- Similar to the *[Fake 5's Chop Move](#the-fake-5s-chop-move)*, players can also violate *Pink Promise* in order to initiate a *5 Pull*, *5 Number Ejection* or a *5 Number Discharge*.
