...
## Pink-Fives & Omni-Fives

### Special 5 Saves for Pink-Fives & Omni-Fives
...
- Turnabout Ejections can be performed on pink-fives, omni-fives, and light-pink fives.
...
- Pseudo-_2 Saves_, _Turnabout Ejections_, and any _5 Tech_ turned off from _pink fives_ also apply to light-pink fives.

### Rank Play Clues on 5s

- There is an additional exception to [_Pink Promise_](pink.mdx#pink-promise):
  - Pink Promise does not apply to rank clues that could represent a playable 5.
- Thus, when players receive a rank _Play Clue_, they have to account for the possibility of it being the true rank and the possibility of it being a playable 5.
- For example, in a 3-player game:
...
- Pseudo-_2 Saves_, _Turnabout Ejections_, _Pink Promise_ on fives, and any _5 Tech_ turned off from _pink fives_ also apply to omni fives.
