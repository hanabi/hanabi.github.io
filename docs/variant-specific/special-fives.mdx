...
- For example, in a 3 player game:
  ...
  - Bob knows that this must be a _Play Clue_. Bob marks the card blue 5.
  - Since _Occam's Razor_ would say play least number of blind cards, Bob plays the "3" as blue 5 since _Self Finesse_ is disabled when 4s are played.
