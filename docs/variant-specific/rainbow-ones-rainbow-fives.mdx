...
- First, see the section on the *[Pink Play Clue Lie](pink.mdx#the-pink-play-clue-lie-ppcl-with-a-mismatched-play-clue-that-touches-other-cards)* (for pink variants).
...
- First, see the section on the *[Pink Prompt Rank Exception](pink.mdx#the-pink-prompt-rank-exception)* (for pink variants).
