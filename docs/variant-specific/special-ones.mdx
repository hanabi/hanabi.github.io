...
- When white-ones is combined with a special suit, the one of that special suit must be play-clued with a number 1 clue, if possible.
- This allows players to give self color bluffs, as the focus of a color clue is then never a one.
