...
- For example, in a 4-player game of the "Null (5 Suits)" variant:
  ...
  - Alice clues 5 to Cathy as a _Null 5's Chop Move_ to _Chop Move_ the null 2.
...
- For example, in a 4-player game of the "Null (5 Suits)" variant:
  ...
  - Alice clues 5 to Cathy as a _Loaded 5 Null Play Clue_.
...
- When a _Double Save_ interpretation is possible, Cathy should always assume that a _Double Save_ has occurred. In other words, Cathy should not assume that Alice performed a _Null 5's Chop Move_ on Bob and that Bob gave her a play clue.
