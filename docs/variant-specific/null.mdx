...
- For example, in a 4-player game of the "Null (5 Suits)" variant:
  ...
  - Alice clues 5 to Cathy as a _Null 5's Chop Move_ to chop move the null 2.
...
- Given that the _Null 5's Chop Move_ only applies to Bob and only chop moves one card, it can be difficult to save two critical cards in a row on Bob.
...
- For example, in a 3-player game of the "Null (5 Suits)" variant:
  ...
  - Normally, since Cathy sees that Bob has a playable null 1 on chop, she would consider this to be a _Loaded 5 Null Play Clue_. However, Cathy knows that _Double Save_ situations take precedence over _Loaded 5 Null Play Clues_. She therefore chop moves her card on slot 5.
