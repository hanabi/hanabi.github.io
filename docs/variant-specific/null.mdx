...
- For example, in a 3-player game of the "Null (5 Suits)" variant:
  ...
  - Normally, since Cathy sees that Bob has a playble null 1 on chop, she would consider this to be a _Loaded 5 Null Play Clue_. However, Cathy knows that _Double Save_ situations take precedence over _Loaded 5 Null Play Clues_.
