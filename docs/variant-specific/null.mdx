...
- Thus, if Bob blindplays a non-null card into a _Null Kick_, he should continue blindplaying cards until he finds a null card.
- He should first blindplay left until playing his _First Finesse Position_, and if he still has not blindplayed a null card, he should play his _Chop Moved_ cards from left to right.

#### The Null Kick Ejection

- Suppose Bob has blindplayed a non-null card from a _Null Kick_, but will not go on to successfully blindplay a null card (perhaps because he does not have a playable null card).
- In this case, Cathy should immediately _Eject_ to prevent Bob from blindplaying any further cards.
