...
- The _5 Save_ and _5's Chop Move_ still work as they would in a no variant game. However, the following other conventions are turned off:
...
- The _Null 5 Chop Move_ is __only__ allowed to save null cards that are critical (or a null 2 that isn't visible elsewhere, same as an ordinary _2 Save_).
