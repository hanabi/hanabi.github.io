...
#### The Null Kick Ejection

- Suppose Bob has blind-played a non-null card from a _Null Kick_, but will not go on to successfully blind-play a null card (perhaps because he does not have a playable null card).
- In this case, Cathy should immediately _Eject_ to stop Bob from blind-playing any further cards.
