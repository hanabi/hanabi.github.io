...
- If Alice gives a rank clue, it is a normal _Play Clue_ on the focused card, and also conveys an additional meaning.
...
- For example:
  ...
  - Cathy blind-plays _Finesse Position_ (slot 2). It is a green 4 and successfully plays on the stacks.
...
- This convention only applies on the very first turn of the game.
- If Alice plays slot 1, Bob _Chop Moves_ once.
- If Alice plays slot 2, Cathy _Chop Moves_ once.
- If Alice plays slot 3:
  - In a 3-player game --> Bob _Chop Moves_ twice.
  - In a 4-player game --> Donald _Chop Moves_ once.
  - In a 5-player game --> Donald _Chop Moves_ once.
- If Alice plays slot 4:
  - In a 3-player game --> Cathy _Chop Moves_ twice.
  - In a 4-player game --> Bob _Chop Moves_ twice.
  - In a 5-player game --> Emily _Chop Moves_ once.
- If Alice plays slot 5:
  - Bob _Chop Moves_ three times.
