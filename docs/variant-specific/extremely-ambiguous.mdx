...
- Blue color clues are only to be used as a last resort, meaning that if it is possibly to cleanly clue the _Second Finesse Position_ with a number clue, then players must do so.
