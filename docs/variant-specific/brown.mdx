...
- All _Brown Tempo Clue_ conventions also apply if brown cards are re-clued to perform a _Finesse_.
...
- [_Loaded Play Clues_](../variant-specific.mdx#the-loaded-play-clue-in-hard-variants-lpc) are always "turned on" for brown cards, according to the [_Always Loaded Principle_](../variant-specific.mdx#the-always-loaded-principle-alp).
