...
- [_Loaded Play Clues_](../variant-specific.mdx#the-loaded-play-clue-in-hard-variants-lpc) are always "turned on" for brown cards, according to the [Always Loaded Principle](../variant-specific.mdx#the-always-loaded-principle-alp).
