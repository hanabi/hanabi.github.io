...
### Trash Discharges and Charms in Pink

- As [previously mentioned](#good-touch-principle), _Good Touch Principle_ applies as normal in pink variants.
- What happens after we clue a trash pink where a single focus would imply bluff (and there are outstanding unknown good pinks)?
- If **any** of the unfocused touched cards are good, this will become a _Unknown Trash Discharge_.
- Otherwise (all touched cards are trash), this is an _Unknown Trash Charm_.
