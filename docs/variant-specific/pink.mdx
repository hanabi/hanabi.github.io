...
- We define the focus of a _5 Pull_ to be the 5 that is directly to the left of the "pulled" card. (This is similar to how _Pink Promise_ works with a _5's Chop Move_.)
