...
### The Pestilent Bubblegum Bluff

- Similar to a _Bubblegum Finesse_ on a _two-away-from-playable_ pink card, it is possible to perform a _Pestilent Bubblegum Bluff_.
- For example, in a 4-player game:
  - It is the first turn and nothing is played on the stacks.
  - Alice clues number 4 to Donald, touching a pink 3 on slot 1.
  - Bob knows that Alice is violating _Pink Promise_. This must mean that he is supposed to play his slot 3 card as pink 1, with pink 2 promised as playable through his current finesse position.
  - Bob blind-plays slot 3, and it is a red 1.
  - From Donald's perspective, he knows that Alice performed a Bubblegum Bluff. Donald marks his slot 1 card as a pink 2 (the pink card that is one-away-from-playable).
  ...
  - Donald realizes that if his clued card was a pink 2, then Cathy would not have done anything. Thus, this must have been a _Pestilent Bubblegum Bluff_. Donald updates the note on his card to be a pink 3.
