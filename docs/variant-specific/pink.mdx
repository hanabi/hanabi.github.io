...
- In Pink, (rank) unfocused touched cards will have soft good touch. What happens after we clue a trash pink where a single focus would imply bluff (and there are outstanding unknown good pinks)?
