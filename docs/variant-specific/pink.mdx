...
- To summarize: When looking for a pink card, look for it in leftmost known pink, then leftmost matching, then leftmost possible true (finesse), then leftmost mismatched, then bluff.
- For example, in a 3-player game:
