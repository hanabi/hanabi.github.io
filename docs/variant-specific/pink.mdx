...
- For example, in a 4-player game:
  ...
  - Cathy discards.
  - Donald knows that clues do not normally _Prompt_ a non-leftmost card. Thus, Donald knows that Bob must be responding to Alice's _Bubblegum Prompt_ on a card that is not actually a 3.
