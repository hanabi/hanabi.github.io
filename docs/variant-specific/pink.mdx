...
### The Unnecessary Trash Lie Charm

- Often, one can perform an _Unknown Trash Discharge_ in pink variants that wasn’t otherwise possible by violating pink’s promise on a trash card with a number clue. 
- In this case, the fact that the clue was a lie doesn’t matter, as it is signaled trash either way, and should be treated as an _Unknown Trash Discharge_.
- However, what if lying about the identity is unnecessary? This must be trying to communicate extra information. In this case, we agree that this calls for an _Unnecessary Trash Lie Charm_.
- For example, in a 3-player game:
  - Pink 2 is played on the stacks
  - Alice clues number 1 to Cathy, touching a pink 2 on slot 5. 
  - Cathy’s hand has no other 1’s or 2’s. 
  - Bob can see that Alice is cluing trash. Playing his _First Finesse Position_ would indicate a _Bubblegum Bluff_ or a _Taffy Bluff_ to Cathy, and so a _Trash Finesse_ is not possible. If Alice intended an _Unknown Trash Discharge_, she could’ve just as easily clued 2’s to Cathy. By lying, she must be trying to communicate something extra. So Bob plays from his Charm slot instead.
  - Cathy sees that a _4-Charm_ was not possible, so concludes that the focused card was trash from an _Unnecessary Trash Lie Charm_. 
- The _Unnecessary Trash Lie Charm_  is similar to _The Unknown Trash Charm (UTC)_, except like _Trash Finesses_ in pink, it only promises the focus of the clue to be trash.

<UnnecessaryTrashLieCharm />

### The Kick Out Charm

- Normally, when unknown trash is called to play and a _Trash Finesse_ doesn’t resolve the identity of the card as trash, this calls for an _Unknown Trash Discharge_. In Pink, if a number clue is used, it’s important that the number doesn’t also match the corresponding play slot, lest it look like a _Bubblegum Bluff_ or a _Taffy Bluff_, and thus a color clue or lying about the identity of the card (for Pink cards) might be expected. However, what if the Discharge position is indicated anyway?
- For example, in a 3-player game:
  - Red 3 and Pink 2 is played on the stack
  - Alice clues number 3 to Cathy, touching a red 3 on slot 5
  - Bob can see that Alice is cluing trash. Playing his _First Finesse Position_ would indicate a _3s Bluff_ to Cathy, and so a _Trash Finesse_ is not possible. However, if Bob plays slot 3 for an _Unknown Trash Discharge_, it will look like a _Bubblegum Bluff_ or a _Taffy Bluff_. Thus, Bob plays his Charm slot instead, since Alice has “kicked out” the conventional Discharge slot.
  - Cathy sees that a _4-Charm_ was not possible, so concludes that the focused card was trash from a _Kick Out Charm_ or an _Unnecessary Trash Lie Charm_.

- The _Kick Out Charm_ is similar to _The Unknown Trash Charm (UTC)_, except like _Trash Finesses_ in pink and _Unnecessary Trash Lie Charms_, it only promises the focus of the clue to be trash.
