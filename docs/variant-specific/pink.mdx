...
### The 5 Stall & 5's Chop Move Pink Promise

- When a player performs a _5 Stall_ or a _5's Chop Move_, it is clearly a type of _Save Clue_. But if two or more 5's are touched as part of the clue, the focus of the clue is unclear.
- We define the focus of a such a clue to be the specific 5 that is closest from the chop.
- Thus, when a player knows for sure that a number 5 clue indicates a _5 Stall_ or a _5's Chop Move_, _Pink Promise_ only applies to the 5 that is closest (or one-away) from the chop.
- For level 19 players, _5 Pulls_ work differently with _Pink Promise_. See _[The 5 Pull Pink Promise](#the-5-pull-pink-promise)_ below.

#### Example 1 : Pink Promise with a _5 Stall_
...
#### Example 2 : Pink Promise with a _5's Chop Move_
...
- Often times a player will receive a number 1 clue that touches a bunch of 1's. In these situations, they will play them all from oldest to newest (using the _1's Assumption_).
...
### The 5 Pull Pink Promise

- First, see the section on _[The 5 Stall & 5's Chop Move Pink Promise](#the-5-stall--5s-chop-move-pink-promise)_.
...
- Note that in the rare case where a _5 Pull_ is performed in a 3-player game by touching two cards in slot 1 and slot 3 with a 5 clue, then the _5 Pulled_ card is slot 2 and hence, **slot 1** is promised to be a 5.
