...
- This rule does not apply when a card has a superposition that specifically includes the prompting card from a special move such as a *4 Charm* or a *Bubblegum Bluff*.
