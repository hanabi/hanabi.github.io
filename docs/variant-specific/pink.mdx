...
- This rule does not apply when a card has a superposition that specifically includes the prompting card from a special move such as a _4 Charm_ or a _Bubblegum Bluff_.
