...
- This rule also applies to "Prompts" triggered by discarding a non-trash pink card, that is, we assume a _Gentleman's Discard_ over a _Sarcastic Discard_ on a potentially misranked copy of the discarded pink card.
