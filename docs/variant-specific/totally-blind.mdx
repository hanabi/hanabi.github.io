...
| Teal     | Double _Chop Move_ (or a nothing clue if in a stalling situation) |
...
| Red      | Double _Chop Move_ (or a nothing clue if in a stalling situation)                    |
| Yellow   | Play slot 1 + play slot 2                                                            |
| Green    | Play slot 1 + play slot 3                                                            |
| Blue     | Play slot 1 + play slot 4                                                            |
...
| Number 5 | Double _Chop Move_ (or a nothing clue if in a stalling situation)                               |
