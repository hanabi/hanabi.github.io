...
- If a player has two of the same playable card in their hand, players are expected to give a positional _Play Clue_ to the leftmost one.
- If a player instead gives a positional _Play Clue_ to the rightmost one, then they are trying to communicate something extra.
...
- For example, in a 3-player game:
  ...
  - Alice clues number 2 to Cathy, giving a _Play Clue_ to Cathy's slot 2.
