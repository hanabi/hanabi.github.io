...
- Note that normally, the _Always Loaded Principle_ applies to white cards, but we agree that it does not apply to the gray 2 when it is saved with a _2 Save_. (This is because the value of giving tempo to a dark card is not as important as being able to save 2's in the early game or in stalling situations.)
