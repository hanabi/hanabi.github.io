...
- Note that normally, the *Always Loaded Principle* applies to white cards, but it does not apply to the gray 2 when it is saved with a _2 Save_. (This is because the value of giving tempo to a dark card is not as important as being able to save 2's early or in stalling situations.)
