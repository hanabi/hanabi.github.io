...
- First, see the section on the *[Fake 5's Chop Move](dark-pink.mdx#the-fake-5s-chop-move)* & the *[Fake 5 Pull](dark-pink.mdx#the-fake-5-pull--the-fake-5-number-discharge)* (in variants with a dark pink suit).
