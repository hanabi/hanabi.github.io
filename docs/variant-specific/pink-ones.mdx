...
- In this variant and in deceptive-ones, it is possible to have 1's in a player's hand that are misranked
- Finesses in this variant work the same as in regular pink, namely play finesse over a misranked 1.
