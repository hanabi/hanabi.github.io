...
import ChopMoveIgnition from "@site/image-generator/yml/level-21/chop-move-ignition.yml";
import ChopMoveIgnitionInteraction from "@site/image-generator/yml/level-21/chop-move-ignition-interaction.yml";
...
- Usually, when this occurs, it is because a player is in a [stalling situation](level-8.mdx#allowable-stall-clues-stall-table) and cannot discard. (This is most common in [the _End-Game_](level-7.mdx#burning-end-game-stalling).)
...
- Usually, when this occurs, it is because a player is in a [stalling situation](level-8.mdx#allowable-stall-clues-stall-table) and cannot discard.
