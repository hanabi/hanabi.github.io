...
- If three or more cards are _Chop Moved_, nothing is promised about the middle cards. (The middle cards, if any, are not _Chop Moved_, and can have any identity.)
