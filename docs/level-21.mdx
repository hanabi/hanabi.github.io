...
import OccupiedSelfFinesse from "@site/image-generator/yml/level-21/occupied-self-finesse.yml";
...
- For example, in a 3-player game:
  ...
  - Alice has a globally known playable red 1 in her hand and Bob has nothing to do.
  - Alice clues number 2 to Cathy, which touches a yellow 2 in slot 2. This would normally be a _Direct Play Clue_ telling Cathy about a blue 2.
  - However, since Alice is _Occupied_ and Bob could have given the exact same clue, and Bob has nothing to do on his turn but to discard, this cannot be a _Direct Play Clue_ and instead must be an _Occupied Finesse_.
  - When Bob does not blind play, Cathy knows she is being self-finessed and is promised a 1 in her finesse position connecting to the hinted 2.
  - Cathy will play her yellow 1 and then play her yellow 2.
