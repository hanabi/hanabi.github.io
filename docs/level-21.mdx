...
import OutOfOrderPlayClue from "./level-21/out-of-order-play-clue.yml";
import OutOfOrderFinesse from "./level-21/out-of-order-finesse.yml";
import FiveColorEjectionInteraction from "./level-21/five-color-ejection-interaction.yml";
import OutOfOrderFinesse2 from "./level-21/out-of-order-finesse-2.yml";
import NoInformationDoubleFinesse from "./level-21/no-information-double-finesse.yml";
import NoInformationDoubleBluff from "./level-21/no-information-double-bluff.yml";

## Special Moves

import OccupiedFinesse from "./level-21/occupied-finesse.yml";
import OccupiedSelfFinesse from "./level-21/occupied-self-finesse.yml";
...
- Sometimes, a card that is not-yet-playable is re-clued in order to initiate a _Finesse_ or a _Bluff_. Most times, the clue will "fill in" or give extra information to the existing card.
- Other times, the clue will give no information to the focused card. For example, re-cluing number 3 to an already known 3. In this situation, if it was merely a _Bluff_, it would be pretty low value.
- Thus, by convention, a "no information" clue like this on a two-away-from-playable card **must** "get" at least 2 new cards (as opposed to a single _Bluff_ that only gets 1 new card).
- For example, in a 3-player game:
