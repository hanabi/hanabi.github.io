...
- This concept applies beyond _Finesses_; it should be applied to any complicated clue. We formalize this as the _Directness Principal_: if two lines would result in identical outcomes, always prefer the line with the least amount of complexity.
