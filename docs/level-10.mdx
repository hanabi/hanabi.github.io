...
- The card **must** be exactly on _Finesse Position_ and **counts as clued** (meaning finesse/ejection/charm positions shift to the right by 1).
- Note that it is **illegal** to perform a _Layered Baton Discard_ and instead would be a _[Blaze Discard](level-24.mdx#the-blaze-discard)_ introduced at level 24.
