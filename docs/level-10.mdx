...
- Similar to the _Gentleman's Discard_, the transferred card counts as being clued. (All players should write a note of exactly the card transferred, "r3" from the example above.)
