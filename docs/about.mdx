...
For those who'd prefer to read this guide on an e-reader or simply access it offline, you can download the [epub version](https://hanabi.github.io/assets/epub/hgroup-conventions.epub). Please note that the epub version is an automatically converted version of the documentation at [hanabi.github.io](https://hanabi.github.io) and may therefore contain some content intended for the web version (e.g. this page's [Hotkeys section](#hotkeys)).
