...
- Example 4:
  - In a 3 player game, Alice has a blue 2 on chop that needs to be saved.
  - Bob has two unknown blue cards. No blue cards are played yet, so from Bob's perspective, each blue card has a 1/9 chance of being the blue 2.
  - Cathy has two unknown 2's. No 2's are played yet, so from Cathy's perspective, each 2 has a 1/9 chance of being the blue 2.
  - The responsibility is shared, so Bob should perform the clue if Cathy has a good discard, or he can discard and let Cathy do it.
