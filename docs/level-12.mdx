...
import Stale1sClue from "./level-12/stale-1s-clue.yml";
import EgoClue from "./level-12/ego-clue.yml";
...
- For example, in a 4-player game:
  ...
  - However, these notes are asymmetric - Alice, Bob, and Donald write the notes, but Cathy does not. (Cathy has no idea that this is happening because Cathy cannot see her own red 2 on chop.)
  - Alice, Bob, and Donald will have to keep this information desync in mind going forward.
...
- Example 1:
  ...
  - Bob has two unknown 2's.
  - Cathy has one unknown 2.
...
- Example 3:
  - In a 3 player game, Alice has a blue 2 on chop that needs to be saved.
  - Bob has two unknown blue cards.
  - Cathy has one unknown 2.
  - Bob should let Cathy perform the save, since 1 matching card is less than 2 matching cards.
...
- Example 4:
  - In a 3 player game, Alice has a blue 2 on chop that needs to be saved.
  - Bob has two unknown blue cards. No blue cards have been played yet, so from Bob's perspective, each blue card has a 1/9 chance of being the blue 2.
  - Cathy has two unknown 2's. No 2's have been played yet, so from Cathy's perspective, each 2 has a 1/9 chance of being the blue 2.
  - The responsibility is shared, so Bob should perform the clue if Cathy has a good discard, or he can discard and let Cathy do it.
...
- Example 5:
  - In a 3 player game, Alice has a blue 2 on chop that needs to be saved.
  - Bob has two unknown blue cards. No blue cards have been played yet, so from Bob's perspective, each blue card has a 1/9 chance of being the blue 2.
  - Cathy has two unknown 2's. One 2 has been played already, so from Cathy's perspective, each 2 has a 1/8 chance of being the blue 2.
...
- For example, in a 3-player game:
  ...
  - Bob's hand is, from newest to oldest: `blue 1, red 3, red 4, red 5, blue 1`
...
- In these types of situations, you can assume that the team is not making any mistakes, which means that the meaning of the clue should be altered from the "textbook" definition. We call these types of clues _Context Clues_ because they rely on contextual reading of the game state.
- The most common _Context Clue_ is given to "stale" 1's towards the beginning of the game. For example, in a 4-player game:
...
- For example, in a 3-player game:
  ...
  - Bob plays the 1. It is a red 1 and successfully plays.
  ...
  - However, his slot 5 card has a negative 1 clue on it (from Alice's number 1 clue earlier), so it explicitly cannot be the blue 1.
  - Thus, this must be _Focus Inversion_ and the blue 1 must be on slot 1. The blue card on slot 5 can be either blue 2, blue 3, blue 4, or blue 5.
...
- For example, in a 3-player game:
  - It is the first turn and nothing is played on the stacks.
  - Bob's hand is, from newest to oldest: `green 4, red 1, red 3, blue 2, blue 1`
...
- For example, in a 4-player game:
  - It is the first turn and nothing is played on the stacks.
  - Cathy's hand is, from newest to oldest: `red 1, green 4, blue 3, blue 1`
  ...
  - Instead, Alice clues red to Donald, performing the _Finesse_ as a 2-for-1. Next, Bob will clue blue to Cathy as a 2-for-1. In total, this is a 4-for-2.
    - These two clues could also be given in the opposite order, but it is slightly safer for Alice to perform the _Finesse_, as she might be holding a blocking card.
...
- For example, in a 3-player game:
  - It is the first turn and nothing is played on the stacks.
  - Cathy's hand is, from newest to oldest: `blue 4, blue 4, red 3, red 1, blue 5`
