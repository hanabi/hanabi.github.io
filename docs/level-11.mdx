...
- We are only allowed to perform *Save Clues* on specific cards and in specific ways, as outlined in [level 1](level-1.mdx#save-clues). For example, we all agree that we must save 5's with number 5.
...
- As explained in the [beginner's guide](beginner/other-general-strategy.mdx), it is almost always better to give a *Play Clue* instead of a *Save Clue* if a player has a playable card in their hand.
