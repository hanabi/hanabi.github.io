...
Are you looking to start playing games with my group? Fantastic - we are always looking to welcome new players. Take 5 minutes and go over [the beginner's guide](https://github.com/Zamiell/hanabi-conventions/blob/master/Beginners.md) so that you can get up to speed with the basics.
